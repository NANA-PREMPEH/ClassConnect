(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function s(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(a){if(a.ep)return;a.ep=!0;const o=s(a);fetch(a.href,o)}})();const Et=(e,t)=>t.some(s=>e instanceof s);let is,os;function jn(){return is||(is=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function On(){return os||(os=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const Tt=new WeakMap,ft=new WeakMap,lt=new WeakMap;function Qn(e){const t=new Promise((s,n)=>{const a=()=>{e.removeEventListener("success",o),e.removeEventListener("error",i)},o=()=>{s(ge(e.result)),a()},i=()=>{n(e.error),a()};e.addEventListener("success",o),e.addEventListener("error",i)});return lt.set(t,e),t}function Fn(e){if(Tt.has(e))return;const t=new Promise((s,n)=>{const a=()=>{e.removeEventListener("complete",o),e.removeEventListener("error",i),e.removeEventListener("abort",i)},o=()=>{s(),a()},i=()=>{n(e.error||new DOMException("AbortError","AbortError")),a()};e.addEventListener("complete",o),e.addEventListener("error",i),e.addEventListener("abort",i)});Tt.set(e,t)}let Bt={get(e,t,s){if(e instanceof IDBTransaction){if(t==="done")return Tt.get(e);if(t==="store")return s.objectStoreNames[1]?void 0:s.objectStore(s.objectStoreNames[0])}return ge(e[t])},set(e,t,s){return e[t]=s,!0},has(e,t){return e instanceof IDBTransaction&&(t==="done"||t==="store")?!0:t in e}};function Ts(e){Bt=e(Bt)}function Gn(e){return On().includes(e)?function(...t){return e.apply(Dt(this),t),ge(this.request)}:function(...t){return ge(e.apply(Dt(this),t))}}function Un(e){return typeof e=="function"?Gn(e):(e instanceof IDBTransaction&&Fn(e),Et(e,jn())?new Proxy(e,Bt):e)}function ge(e){if(e instanceof IDBRequest)return Qn(e);if(ft.has(e))return ft.get(e);const t=Un(e);return t!==e&&(ft.set(e,t),lt.set(t,e)),t}const Dt=e=>lt.get(e);function Hn(e,t,{blocked:s,upgrade:n,blocking:a,terminated:o}={}){const i=indexedDB.open(e,t),r=ge(i);return n&&i.addEventListener("upgradeneeded",d=>{n(ge(i.result),d.oldVersion,d.newVersion,ge(i.transaction),d)}),s&&i.addEventListener("blocked",d=>s(d.oldVersion,d.newVersion,d)),r.then(d=>{o&&d.addEventListener("close",()=>o()),a&&d.addEventListener("versionchange",c=>a(c.oldVersion,c.newVersion,c))}).catch(()=>{}),r}const Wn=["get","getKey","getAll","getAllKeys","count"],Kn=["put","add","delete","clear"],bt=new Map;function rs(e,t){if(!(e instanceof IDBDatabase&&!(t in e)&&typeof t=="string"))return;if(bt.get(t))return bt.get(t);const s=t.replace(/FromIndex$/,""),n=t!==s,a=Kn.includes(s);if(!(s in(n?IDBIndex:IDBObjectStore).prototype)||!(a||Wn.includes(s)))return;const o=async function(i,...r){const d=this.transaction(i,a?"readwrite":"readonly");let c=d.store;return n&&(c=c.index(r.shift())),(await Promise.all([c[s](...r),a&&d.done]))[0]};return bt.set(t,o),o}Ts(e=>({...e,get:(t,s,n)=>rs(t,s)||e.get(t,s,n),has:(t,s)=>!!rs(t,s)||e.has(t,s)}));const Yn=["continue","continuePrimaryKey","advance"],cs={},Mt=new WeakMap,Bs=new WeakMap,Vn={get(e,t){if(!Yn.includes(t))return e[t];let s=cs[t];return s||(s=cs[t]=function(...n){Mt.set(this,Bs.get(this)[t](...n))}),s}};async function*Jn(...e){let t=this;if(t instanceof IDBCursor||(t=await t.openCursor(...e)),!t)return;t=t;const s=new Proxy(t,Vn);for(Bs.set(s,t),lt.set(s,Dt(t));t;)yield s,t=await(Mt.get(s)||t.continue()),Mt.delete(s)}function ds(e,t){return t===Symbol.asyncIterator&&Et(e,[IDBIndex,IDBObjectStore,IDBCursor])||t==="iterate"&&Et(e,[IDBIndex,IDBObjectStore])}Ts(e=>({...e,get(t,s,n){return ds(t,s)?Jn:e.get(t,s,n)},has(t,s){return ds(t,s)||e.has(t,s)}}));const Zn="classconnect",Ds=8,je="settings",ie="feedbackCache",Rt="classconnect:datachange",Xn="classconnect-data-sync",it="cc_teacherAuthenticated",Ms="cc_currentStudent",ea=["apiKey","teacherPin","theme"];let we=null,yt=null;var Ze,Es;const Rs=((Es=(Ze=globalThis.crypto)==null?void 0:Ze.randomUUID)==null?void 0:Es.call(Ze))||`cc-${Date.now()}-${Math.random().toString(16).slice(2)}`;function Ps(){return typeof BroadcastChannel>"u"?null:(yt||(yt=new BroadcastChannel(Xn)),yt)}function Q(e,t,s=null){var a;const n={store:e,action:t,recordId:(s==null?void 0:s.id)??(s==null?void 0:s.studentId)??(s==null?void 0:s.cacheKey)??null,timestamp:new Date().toISOString(),sourceId:Rs};typeof window<"u"&&window.dispatchEvent(new CustomEvent(Rt,{detail:n}));try{(a=Ps())==null||a.postMessage(n)}catch{}return n}function ta(e){const t=a=>{a!=null&&a.detail&&e(a.detail)};typeof window<"u"&&window.addEventListener(Rt,t);const s=Ps(),n=a=>{!(a!=null&&a.data)||a.data.sourceId===Rs||e(a.data)};return s==null||s.addEventListener("message",n),()=>{typeof window<"u"&&window.removeEventListener(Rt,t),s==null||s.removeEventListener("message",n)}}function sa(e,t=null){if(!e.objectStoreNames.contains("classes")){const s=e.createObjectStore("classes",{keyPath:"id",autoIncrement:!0});s.createIndex("gradeLevel","gradeLevel",{unique:!1}),s.createIndex("academicYear","academicYear",{unique:!1})}if(e.objectStoreNames.contains("students")){if(t){const s=t.objectStore("students");s.indexNames.contains("classId")||s.createIndex("classId","classId",{unique:!1}),s.indexNames.contains("indexNumber")||s.createIndex("indexNumber","indexNumber",{unique:!1})}}else{const s=e.createObjectStore("students",{keyPath:"id",autoIncrement:!0});s.createIndex("name","name",{unique:!1}),s.createIndex("classId","classId",{unique:!1}),s.createIndex("indexNumber","indexNumber",{unique:!1})}if(e.objectStoreNames.contains("progress")||e.createObjectStore("progress",{keyPath:"id",autoIncrement:!0}).createIndex("studentId","studentId",{unique:!1}),!e.objectStoreNames.contains("quizResults")){const s=e.createObjectStore("quizResults",{keyPath:"id",autoIncrement:!0});s.createIndex("studentId","studentId",{unique:!1}),s.createIndex("lessonId","lessonId",{unique:!1})}if(e.objectStoreNames.contains("diagnostics")||e.createObjectStore("diagnostics",{keyPath:"id",autoIncrement:!0}).createIndex("studentId","studentId",{unique:!1}),e.objectStoreNames.contains("tutorThreads")||e.createObjectStore("tutorThreads",{keyPath:"studentId"}),e.objectStoreNames.contains("assessments")||e.createObjectStore("assessments",{keyPath:"id",autoIncrement:!0}).createIndex("createdAt","createdAt",{unique:!1}),!e.objectStoreNames.contains("assessmentSubmissions")){const s=e.createObjectStore("assessmentSubmissions",{keyPath:"id",autoIncrement:!0});s.createIndex("assessmentId","assessmentId",{unique:!1}),s.createIndex("studentId","studentId",{unique:!1})}if(!e.objectStoreNames.contains(ie)){const s=e.createObjectStore(ie,{keyPath:"cacheKey"});s.createIndex("questionId","questionId",{unique:!1}),s.createIndex("updatedAt","updatedAt",{unique:!1})}if(e.objectStoreNames.contains(je)||e.createObjectStore(je,{keyPath:"key"}),e.objectStoreNames.contains("customLessons")||e.createObjectStore("customLessons",{keyPath:"id",autoIncrement:!0}).createIndex("strand","strand",{unique:!1}),e.objectStoreNames.contains("questionBank")||e.createObjectStore("questionBank",{keyPath:"id",autoIncrement:!0}).createIndex("type","type",{unique:!1}),!e.objectStoreNames.contains("users")){const s=e.createObjectStore("users",{keyPath:"id",autoIncrement:!0});s.createIndex("username","username",{unique:!0}),s.createIndex("role","role",{unique:!1})}e.objectStoreNames.contains("auditLog")||e.createObjectStore("auditLog",{keyPath:"id",autoIncrement:!0}).createIndex("createdAt","createdAt",{unique:!1})}function $(){return we||(we=Hn(Zn,Ds,{upgrade(e,t,s,n){sa(e,n)},blocked(e,t,s){console.warn(`[ClassConnect] IndexedDB upgrade blocked (v${e} → v${t}). Close other ClassConnect tabs or clear site data, then try again.`)},blocking(e,t,s){s.target.close(),we=null},terminated(){we=null}}).catch(e=>{throw we=null,e})),we}function qs(e){try{return localStorage.getItem(`cc_${e}`)}catch{return null}}function Ut(e,t){try{if(t==null||t===""){localStorage.removeItem(`cc_${e}`);return}localStorage.setItem(`cc_${e}`,t)}catch{}}async function Ht(e,t){await(await $()).put(je,{key:e,value:t,updatedAt:new Date().toISOString()})}async function na(){const e=await $();try{await Kt(e)}catch(t){console.warn("[ClassConnect] Default class migration notice:",t)}await Promise.all(ea.map(async t=>{const s=await e.get(je,t);if(s!=null&&s.value){Ut(t,s.value);return}const n=qs(t);n&&await Ht(t,n)}))}function F(e){return qs(e)}function Ns(e,t){Ut(e,t),Ht(e,t)}async function zs(e,t){Ut(e,t),await Ht(e,t)}function Ae(){return F("apiKey")}async function js(e){await zs("apiKey",e)}function Wt(){return F("teacherPin")}async function Os(e){await zs("teacherPin",e)}async function Kt(e=null){const t=e||await $();let n=(await t.getAll("classes"))[0];if(!n){const r=new Date().toISOString();n={id:await t.add("classes",{name:"B7 — JHS 1A",gradeLevel:"B7",stream:"1A",academicYear:"2026/2027",term:"Term 1",teacherName:"Class Teacher",createdAt:r}),name:"B7 — JHS 1A",gradeLevel:"B7",stream:"1A",academicYear:"2026/2027",term:"Term 1",teacherName:"Class Teacher",createdAt:r},Q("classes","create",n)}const a=await t.getAll("students"),o=t.transaction("students","readwrite");let i=0;for(const r of a){let d=!1;r.classId||(r.classId=n.id,d=!0),r.status||(r.status="active",d=!0),r.gender||(r.gender="unspecified",d=!0),r.indexNumber||(r.indexNumber=`GES-B7-${String(r.id).padStart(4,"0")}`,d=!0),d&&(await o.store.put(r),i+=1)}return await o.done,{defaultClass:n,migratedCount:i}}async function aa(e){var i,r;const t=await $(),s=new Date().toISOString(),n={name:((i=e.name)==null?void 0:i.trim())||`${e.gradeLevel||"B7"} — ${e.stream||"Stream A"}`,gradeLevel:e.gradeLevel||"B7",stream:e.stream||"A",academicYear:e.academicYear||"2026/2027",term:e.term||"Term 1",teacherName:((r=e.teacherName)==null?void 0:r.trim())||"Class Teacher",createdAt:s},a=await t.add("classes",n),o={...n,id:a};return Q("classes","create",o),o}async function se(){const e=await $(),t=await e.getAll("classes");if(t.length===0){const{defaultClass:s}=await Kt(e);return s?[s]:[]}return t}async function ia(e,t,s={}){var u,l;const n=await $(),a=await oa(e,t);if(a)return a;let o=s.classId;o||(o=((u=(await se())[0])==null?void 0:u.id)||1);const i=new Date().toISOString(),r={name:e.trim(),pin:t,classId:o,indexNumber:((l=s.indexNumber)==null?void 0:l.trim())||null,gender:s.gender||"unspecified",status:s.status||"active",createdAt:i},d=await n.add("students",r);r.indexNumber||(r.indexNumber=`GES-B7-${String(d).padStart(4,"0")}`,await n.put("students",{...r,id:d}));const c={...r,id:d};return Q("students","create",c),c}async function oa(e,t){return(await(await $()).getAllFromIndex("students","name",e.trim())).find(a=>a.pin===t)||null}async function ra(e,t){const s=await $(),n=(e||"").trim().toLowerCase();if(!n)return null;const a=await s.getAll("students"),o=a.find(r=>r.indexNumber&&r.indexNumber.trim().toLowerCase()===n&&r.pin===t);return o||a.find(r=>r.name&&r.name.trim().toLowerCase()===n&&r.pin===t)||null}async function Qs(e,t){const s=await $(),n=await s.get("students",e);if(!n)return null;const a={...n,...t,id:e,updatedAt:new Date().toISOString()};return await s.put("students",a),Q("students","update",a),a}async function ca(e,t){if(!/^\d{4}$/.test(t))throw new Error("PIN must be exactly 4 numeric digits.");return Qs(e,{pin:t})}async function da(e){var i,r;const t=await $(),s={created:[],updated:[],errors:[]},n=await t.getAll("students"),a=t.transaction("students","readwrite"),o=a.store;for(const d of e)try{const c=(i=d.name)==null?void 0:i.trim(),u=(r=d.indexNumber)==null?void 0:r.trim();if(!c){s.errors.push({item:d,error:"Student name is required."});continue}let l=null;if(u&&(l=n.find(p=>p.indexNumber&&p.indexNumber.toLowerCase()===u.toLowerCase())),l||(l=n.find(p=>p.name&&p.name.toLowerCase()===c.toLowerCase()&&p.classId===(d.classId||p.classId))),l){const p={...l,...d,id:l.id,name:c,indexNumber:u||l.indexNumber,updatedAt:new Date().toISOString()};await o.put(p),s.updated.push(p)}else{const p=d.pin&&/^\d{4}$/.test(d.pin)?d.pin:String(Math.floor(1e3+Math.random()*9e3)),h={name:c,pin:p,classId:d.classId||1,indexNumber:u||null,gender:d.gender||"unspecified",status:d.status||"active",createdAt:new Date().toISOString()},m=await o.add(h);h.indexNumber||(h.indexNumber=`GES-B7-${String(m).padStart(4,"0")}`,await o.put({...h,id:m})),s.created.push({...h,id:m})}}catch(c){s.errors.push({item:d,error:c.message})}return await a.done,Q("students","bulk",s),s}async function Y(){return(await $()).getAll("students")}async function la(e,t){const s=await $(),a=(await J(e)).find(d=>d.lessonId===t);if(a)return a;const o=new Date().toISOString(),r={id:await s.add("progress",{studentId:e,lessonId:t,completedAt:o}),studentId:e,lessonId:t,completedAt:o};return Q("progress","create",r),r}async function J(e){return(await $()).getAllFromIndex("progress","studentId",e)}async function ut(){return(await $()).getAll("progress")}async function ua(e,t){return(await J(e)).some(n=>n.lessonId===t)}async function pa(e){const t=await $(),s=new Date().toISOString(),n={...e,completedAt:s},a=await t.add("quizResults",n),o={...n,id:a};return Q("quizResults","create",o),o}async function ve(e){return(await $()).getAllFromIndex("quizResults","studentId",e)}async function fe(){return(await $()).getAll("quizResults")}async function ma(e){const t=await $(),s=new Date().toISOString(),n={...e,completedAt:s},a=await t.add("diagnostics",n),o={...n,id:a};return Q("diagnostics","create",o),o}async function Fs(e){return(await $()).get("diagnostics",e)}async function ha(e){return(await $()).getAllFromIndex("diagnostics","studentId",e)}async function ne(e){return(await ha(e)).slice().sort((s,n)=>new Date(n.completedAt)-new Date(s.completedAt))[0]||null}async function pt(){return(await $()).getAll("diagnostics")}async function ga(e){return(await $()).get("tutorThreads",e)}async function ls(e,t){const s=await $(),n={studentId:e,messages:t.slice(-20),updatedAt:new Date().toISOString()};return await s.put("tutorThreads",n),Q("tutorThreads","upsert",n),n}async function va(e){await(await $()).delete("tutorThreads",e),Q("tutorThreads","delete",{studentId:e})}async function fa(e){const t=await $(),s={...e,createdAt:e.createdAt||new Date().toISOString()},n=await t.add("assessments",s),a={...s,id:n};return Q("assessments","create",a),a}async function ba(e){return(await $()).get("assessments",e)}async function Ge(){return(await $()).getAll("assessments")}async function ya(e){const t=await $(),s={...e,completedAt:e.completedAt||new Date().toISOString()},n=await t.add("assessmentSubmissions",s),a={...s,id:n};return Q("assessmentSubmissions","create",a),a}async function Gs(e){return(await $()).getAllFromIndex("assessmentSubmissions","studentId",e)}async function be(){return(await $()).getAll("assessmentSubmissions")}async function wa(e){return(await $()).get(ie,e)}async function Ia(e){return(await $()).getAllFromIndex(ie,"questionId",e)}async function Sa(e){const t=await $(),s=await t.get(ie,e.cacheKey),n=new Date().toISOString(),a={...s,...e,createdAt:(s==null?void 0:s.createdAt)||e.createdAt||n,updatedAt:n,usageCount:e.usageCount||(s?(s.usageCount||0)+1:1),lastUsedAt:e.lastUsedAt||n};return await t.put(ie,a),a}async function Yt(e){const t=await $(),s=await t.get(ie,e);if(!s)return null;const n={...s,usageCount:(s.usageCount||0)+1,lastUsedAt:new Date().toISOString()};return await t.put(ie,n),n}function _a(e){sessionStorage.setItem(Ms,JSON.stringify(e))}function P(){try{const e=sessionStorage.getItem(Ms);return e?JSON.parse(e):null}catch{return null}}function us(e=!0){if(!e){sessionStorage.removeItem(it);return}sessionStorage.setItem(it,JSON.stringify({authenticated:!0,role:"admin",updatedAt:new Date().toISOString()}))}function ps(){var e;try{const t=sessionStorage.getItem(it);return!!(t&&((e=JSON.parse(t))!=null&&e.authenticated))}catch{return!1}}function ka(){sessionStorage.removeItem(it)}async function Us(e){const t=await $(),s={...e,updatedAt:new Date().toISOString(),createdAt:e.createdAt||new Date().toISOString()},n=e.id?(await t.put("customLessons",s),e.id):await t.add("customLessons",s),a={...s,id:n};return Q("customLessons",e.id?"update":"create",a),await Vt("lesson.saved",{lessonId:n,title:s.title}),a}async function Hs(){return(await $()).getAll("customLessons")}async function xa(){return{app:"ClassConnect",type:"ccpack",version:1,exportedAt:new Date().toISOString(),lessons:await Hs(),questions:await Ks()}}async function $a(e){if(!e||e.app!=="ClassConnect"||e.type!=="ccpack")throw new Error("This is not a ClassConnect lesson pack.");const t=Array.isArray(e.lessons)?e.lessons:[],s=Array.isArray(e.questions)?e.questions:[];for(const n of t){const{id:a,...o}=n;await Us(o)}for(const n of s){const{id:a,...o}=n;await Ws(o)}return await Vt("lesson-pack.imported",{lessons:t.length,questions:s.length}),{lessons:t.length,questions:s.length}}async function Ws(e){const t=await $(),s={...e,updatedAt:new Date().toISOString(),createdAt:e.createdAt||new Date().toISOString()},n=e.id?(await t.put("questionBank",s),e.id):await t.add("questionBank",s),a={...s,id:n};return Q("questionBank",e.id?"update":"create",a),await Vt("question.saved",{questionId:n,type:s.type}),a}async function Ks(){return(await $()).getAll("questionBank")}async function Vt(e,t={}){const n=await(await $()).add("auditLog",{action:e,detail:t,actor:F("activeTeacher")||"teacher",createdAt:new Date().toISOString()});return Q("auditLog","create",{id:n}),n}async function Aa(){var n;const e=await Y(),t=await fe();let s=`Student Name,Lesson,Score,Total Questions,Ability (theta),Level,Completed At,Total Time (s)
...
`}return s}function Ys(e,t="classconnect_data.csv"){const s=new Blob([e],{type:"text/csv;charset=utf-8;"}),n=URL.createObjectURL(s),a=document.createElement("a");a.href=n,a.download=t,a.click(),URL.revokeObjectURL(n)}const Ca=["classes","students","progress","quizResults","diagnostics","tutorThreads","assessments","assessmentSubmissions","customLessons","questionBank","users","auditLog",ie,je];async function La(){const e=await $(),t={};for(const s of Ca)e.objectStoreNames.contains(s)&&(t[s]=await e.getAll(s));return{app:"ClassConnect",schemaVersion:Ds,exportedAt:new Date().toISOString(),data:t}}async function Ea(){const e=await La(),t=JSON.stringify(e,null,2),s=new Date().toISOString().slice(0,10),n=new Blob([t],{type:"application/json;charset=utf-8;"}),a=URL.createObjectURL(n),o=document.createElement("a");return o.href=a,o.download=`classconnect_school_backup_${s}.json`,o.click(),URL.revokeObjectURL(a),e}async function Ta(e,t="merge"){if(!e||e.app!=="ClassConnect"||!e.data)throw new Error("Invalid ClassConnect backup file. Expected valid JSON with app metadata.");const s=await $(),n={};for(const[a,o]of Object.entries(e.data)){if(!s.objectStoreNames.contains(a)||!Array.isArray(o))continue;const i=s.transaction(a,"readwrite");t==="overwrite"&&await i.store.clear();let r=0;for(const d of o)await i.store.put(d),r+=1;await i.done,n[a]=r}return await Kt(s),Q("all","restore",n),n}const Ba="dark";function Vs(e){return e==="light"?"light":Ba}function Jt(){return Vs(F("theme"))}function Js(e){const t=Vs(e);return document.documentElement.dataset.theme=t,document.documentElement.style.colorScheme=t,t}function Da(e){const t=Js(e);return Ns("theme",t),t}function Ma(){return Da(Jt()==="dark"?"light":"dark")}function Ra(){return Js(Jt())}function Pa(e){if(!("speechSynthesis"in window)||!e)return!1;window.speechSynthesis.cancel();const t=new SpeechSynthesisUtterance(e.replace(/<[^>]*>/g," "));return t.rate=Number(F("speechRate")||1),window.speechSynthesis.speak(t),!0}function qa(){var e;(e=window.speechSynthesis)==null||e.cancel()}function Zs(){const e=document.documentElement;e.dataset.contrast=F("highContrast")==="true"?"high":"standard",e.dataset.readingFont=F("dyslexiaFont")==="true"?"dyslexia":"standard",e.dataset.fontScale=F("fontScale")||"standard"}function Na(e){Object.entries(e).forEach(([t,s])=>Ns(t,String(s))),Zs()}function Xs(e){return e==="light"?`
  ...
  `}function za(){const e=Jt(),t=e==="dark"?"light":"dark";return`
            ...
            <div class="nav__toolbar">
              <details class="nav__accessibility">
                ...
                <div class="nav__accessibility-panel">
                  ...
                  <label><input id="access-high-contrast" type="checkbox" ${F("highContrast")==="true"?"checked":""}> High contrast</label>
                  <label><input id="access-dyslexia-font" type="checkbox" ${F("dyslexiaFont")==="true"?"checked":""}> Dyslexia-friendly font</label>
                  <label>Text size <select id="access-font-scale"><option value="standard">Standard</option><option value="large" ${F("fontScale")==="large"?"selected":""}>Large</option><option value="extra-large" ${F("fontScale")==="extra-large"?"selected":""}>Extra large</option></select></label>
                  <label>Speech speed <select id="access-speech-rate"><option value="0.8">Slow</option><option value="1" ${F("speechRate")!=="0.8"&&F("speechRate")!=="1.2"?"selected":""}>Normal</option><option value="1.2" ${F("speechRate")==="1.2"?"selected":""}>Fast</option></select></label>
                </div>
              </details>
              ${d?za():""}
              ${o?`
  ...
  `}function q(e={}){const{onBack:t=null,onSettings:s=null,onBrand:n=null,onLogout:a=null}=e,o=document.getElementById("nav-back-btn");o&&t&&o.addEventListener("click",t);const i=document.getElementById("nav-settings-btn");i&&s&&i.addEventListener("click",s);const r=document.getElementById("nav-logout-btn");r&&a&&r.addEventListener("click",a);const d=document.getElementById("nav-theme-btn");d&&d.addEventListener("click",()=>{const p=Ma(),h=p==="dark"?"light":"dark";d.innerHTML=Xs(p),d.setAttribute("aria-label",`Switch to ${h} theme`),d.setAttribute("title",`Switch to ${h} theme`)});const c=()=>{var p,h,m,g;return Na({highContrast:((p=document.getElementById("access-high-contrast"))==null?void 0:p.checked)||!1,dyslexiaFont:((h=document.getElementById("access-dyslexia-font"))==null?void 0:h.checked)||!1,fontScale:((m=document.getElementById("access-font-scale"))==null?void 0:m.value)||"standard",speechRate:((g=document.getElementById("access-speech-rate"))==null?void 0:g.value)||"1"})};["access-high-contrast","access-dyslexia-font","access-font-scale","access-speech-rate"].forEach(p=>{var h;return(h=document.getElementById(p))==null?void 0:h.addEventListener("change",c)});const u=document.getElementById("nav-brand");u&&n&&(u.addEventListener("click",n),u.style.cursor="pointer");const l=()=>{const p=document.getElementById("status-dot"),h=document.getElementById("status-text");p&&(p.className=`status-dot ${navigator.onLine?"status-dot--online":"status-dot--offline"}`),h&&(h.textContent=navigator.onLine?"Online":"Offline")};window.addEventListener("online",l),window.addEventListener("offline",l)}function ja(){return`
  ...
  `}function Oa(e){q(),document.getElementById("btn-student").addEventListener("click",()=>{e("/student-login")}),document.getElementById("btn-teacher").addEventListener("click",()=>{e("/teacher-login")})}function Ue(e,t,s=""){const n=t>0?Math.round(e/t*100):0;return`
  ...
  `}function en(e){const t=["A","B","C","D"];return`
  ...
  `}function Qa(e){return e==="ai"?'<span class="badge badge--primary">AI Feedback</span>':e==="cache"?'<span class="badge badge--accent">Saved Offline</span>':e==="question-cache"?'<span class="badge badge--warning">Common Offline Hint</span>':e==="fallback"?'<span class="badge badge--neutral">Offline Hint</span>':'<span class="badge badge--success">Quick Check</span>'}function Fa(e){return e.source==="ai"?"Powered by Gemini AI and saved for offline reuse.":e.source==="cache"?"Loaded from this device cache so feedback still works offline.":e.source==="question-cache"?"Reused from a common explanation for this question while offline.":e.source==="fallback"?"Using the built-in lesson explanation because no saved AI response matched yet.":""}function Ga(e,t){return t||!e.practiceTip?"":`
    <div class="feedback-card__tip">
      <strong>Next step:</strong> ${e.practiceTip}
    </div>
  `}function Ua(e,t){return t||!e.usageCount&&!e.reusedFromQuestionBank?"":e.reusedFromQuestionBank?'<div class="feedback-card__meta">Misconception memory: reused a common explanation for this question.</div>':(e.usageCount||0)>1?`<div class="feedback-card__meta">Misconception memory: this saved explanation has helped ${e.usageCount} times on this device.</div>`:""}function Zt(e,t){const s=t?"Correct":"Review",n=t?"Correct!":"Let's learn from this",a=Fa(e);return`
  ...
  `}function Ie(e,t,s,n="primary",a=""){return`
  ...
  `}let Ce=null;function C(e,t="info",s=3e3){Ce||(Ce=document.createElement("div"),Ce.className="toast-container",document.body.appendChild(Ce));const n={success:"OK",error:"X",info:"i"},a=document.createElement("div");a.className=`toast toast--${t}`,a.innerHTML=`<span>${n[t]||""}</span> ${e}`,Ce.appendChild(a),setTimeout(()=>{a.style.opacity="0",a.style.transform="translateX(100%)",a.style.transition="all 0.3s ease-out",setTimeout(()=>a.remove(),300)},s)}function tn(e,t){const s=t>0?e/t:0,n=2*Math.PI*45,a=n*(1-s);let o="#FB7185";return s>=.8?o="#34D399":s>=.6?o="#818CF8":s>=.4&&(o="#FBBF24"),`
  ...
  `}function le(e,t,s=[],n={}){const a=document.createElement("div");a.className="modal-overlay",a.id="modal-overlay";const o=n.modalClass?` ${n.modalClass}`:"";return a.innerHTML=`
    <div class="modal${o}">
  ...
  `,document.body.appendChild(a),s.forEach((i,r)=>{const d=document.getElementById(`modal-action-${r}`);d&&d.addEventListener("click",async()=>{let c=!0;i.onClick&&(c=await i.onClick(a)!==!1),c&&a.remove()})}),a.addEventListener("click",i=>{i.target===a&&a.remove()}),a}function Ha(){return`
    ...
    <div class="bg-pattern"></div>
  `}function Wa(e){q({onBack:()=>e("/")});const t=document.getElementById("login-form"),s=document.getElementById("student-name"),n=document.getElementById("student-pin");t.addEventListener("submit",async i=>{var c,u;i.preventDefault();const r=s.value.trim(),d=n.value;if(!r||d.length!==4){C("Please enter your name or index number and a 4-digit PIN.","error");return}try{let l=await ra(r,d);l||(l=await ia(r,d)),_a(l);const p=await ne(l.id);e(p?"/lessons":"/diagnostic")}catch(l){console.error("[ClassConnect] Student login error:",l);let p="Login failed. Please try again.";(l==null?void 0:l.message)==="The local ClassConnect database is busy."?p="Your saved learning data is busy. Close other ClassConnect tabs, then try again.":((l==null?void 0:l.name)==="VersionError"||(c=l==null?void 0:l.message)!=null&&c.includes("version")||(u=l==null?void 0:l.message)!=null&&u.includes("blocked"))&&(p="A database update is needed. Please close all other ClassConnect tabs and try again."),C(p,"error")}});const a=document.getElementById("recent-students"),o=document.getElementById("recent-student-list");o.addEventListener("click",i=>{const r=i.target.closest(".student-quick-select");r&&(s.value=r.dataset.identifier||r.dataset.name,n.focus())}),Promise.all([Y(),se()]).then(([i,r])=>{i.length&&(i.slice(0,6).forEach(d=>{const c=r.find(p=>p.id===d.classId),u=c?` [${c.stream||c.name}]`:"",l=document.createElement("button");l.type="button",l.className="badge badge--neutral student-quick-select",l.dataset.name=d.name,l.dataset.identifier=d.indexNumber||d.name,l.style.cssText="padding: var(--space-2) var(--space-3); cursor: pointer; border: 1px solid var(--color-slate-600);",l.textContent=`${d.name}${u}`,o.append(l)}),a.hidden=!1)}).catch(i=>{console.warn("Recent students could not be loaded.",i)})}function Ka(){const t=!Wt();return`
        ...
        <form id="teacher-access-form" style="display: flex; flex-direction: column; gap: var(--space-6);">
          ...
          ${t?`
            ...
            <div class="input-group">
              ...
              <input type="password" id="teacher-api-key" class="input" value="${Ae()||""}" placeholder="AIzaSy...">
            </div>
          `:""}
  ...
  `}function Ya(e){q({onBack:()=>e("/")});const t=Wt(),s=!t,n=document.getElementById("teacher-access-form"),a=document.getElementById("teacher-pin"),o=document.getElementById("teacher-pin-confirm"),i=document.getElementById("teacher-api-key");n.addEventListener("submit",async r=>{r.preventDefault();const d=a.value.trim();if(!/^\d{4}$/.test(d)){C("Enter a valid 4-digit teacher PIN.","error");return}if(s){const c=o==null?void 0:o.value.trim();if(d!==c){C("Teacher PINs do not match yet.","error");return}try{await Os(d),i!=null&&i.value.trim()&&await js(i.value.trim()),us(!0),C("Teacher access saved for this device.","success"),e("/dashboard")}catch(u){console.error(u),C("Unable to save teacher access right now.","error")}return}if(d!==t){C("That teacher PIN is not correct.","error");return}us(!0),e("/dashboard")})}const L=[{id:1,title:"What Is a Computer?",duration:"10 min",objectives:["Define what a computer is and explain its basic purpose","Identify different types of computers used today","Understand how computers have evolved through generations"],keyTerms:[{word:"Computer",definition:"An electronic device that accepts data (input), processes it, and produces useful information (output)."},{word:"Data",definition:"Raw facts and figures that have not yet been processed — such as numbers, words, or images."},{word:"Information",definition:"Data that has been processed and organized so it is meaningful and useful."},{word:"Hardware",definition:"The physical parts of a computer that you can see and touch."},{word:"Software",definition:"Programs and instructions that tell the computer what to do."}],content:`
    ...
    `}],Va={1:{src:"/images/lesson-1-computer-types.png",alt:"Illustration of a desktop computer, laptop, tablet, smartphone, and server tower",caption:"Different types of computers suit different jobs, but they all accept data, process it, and give useful results."},2:{src:"/images/lesson-2-inside-computer.png",alt:"Illustration of a desktop tower opened to show the motherboard, CPU, RAM, storage drive, and power supply",caption:"Internal hardware works together through the motherboard so the CPU, memory, storage, and power system can do their jobs."},3:{src:"/images/lesson-3-input-devices.png",alt:"Illustration collage of a keyboard, mouse, touchscreen tablet, microphone, scanner, and webcam",caption:"Input devices help students send text, sound, touch, and images into a computer."},4:{src:"/images/lesson-4-output-devices.png",alt:"Illustration collage of a monitor, printer, speakers, projector, and plotter",caption:"Output devices help the computer present information as visuals, sound, or printed work."},5:{src:"/images/lesson-5-storage-devices.png",alt:"Illustration comparing a hard drive, solid state drive, flash drive, SD card, optical disc, and cloud storage symbol",caption:"Storage devices keep schoolwork, software, and media safe so learners can use them again later."}};function sn(e,t=0,s=1){return Math.max(t,Math.min(s,e))}function Xt(e){return e.length?e.reduce((t,s)=>t+s,0)/e.length:0}function Ja(e){return Math.round(sn(e)*100)}function nn(e){const t=(e==null?void 0:e.lessonBreakdown)||[];return new Map(t.map(s=>[s.lessonId,s]))}function Za(e){const t=new Map;return e.slice().sort((s,n)=>new Date(n.completedAt)-new Date(s.completedAt)).forEach(s=>{t.has(s.lessonId)||t.set(s.lessonId,s)}),t}function Xa(e){const t=new Map;return e.slice().sort((s,n)=>new Date(n.completedAt)-new Date(s.completedAt)).slice(0,3).forEach(s=>{var a;const n=((a=s.responses)==null?void 0:a.filter(o=>!o.correct).length)||0;t.set(s.lessonId,(t.get(s.lessonId)||0)+n)}),t}function ei(e){return e>=.8?"mastered":e>=.6?"growing":e>=.4?"review":"urgent"}function ti(e){const t=Xt(e.map(n=>n.mastery)),s=e.filter(n=>n.status==="urgent").length;return t>=.75&&s===0?{label:"Ready to Accelerate",tone:"success",description:"You have strong foundations across the strand. Push into harder quizzes and extension practice."}:t>=.55?{label:"Foundations Growing",tone:"accent",description:"You are building confidence. Focus on the weakest topics first, then continue the recommended path."}:{label:"Needs Guided Support",tone:"danger",description:"Your learning path should begin with a few targeted reviews before moving ahead."}}function si(e,t,s){const n=Xa(t),a=nn(s);return e.map(i=>{const r=a.get(i.lessonId),d=n.get(i.lessonId)||0,c=[];let u=0;return r&&r.accuracy<.5&&(c.push("low diagnostic readiness"),u+=25),i.latestQuizScore!==null&&i.latestQuizScore<.6&&(c.push("recent quiz performance dropped"),u+=20),d>0&&(c.push(`${d} recent missed question${d===1?"":"s"}`),u+=d*6),i.completed||(u+=8),!c.length&&i.mastery>=.65?null:{lessonId:i.lessonId,title:i.title,priority:u,reason:c.length?c.join(", "):"This topic will benefit from one more focused review.",action:`Revisit ${i.title}, then use the AI Tutor before retaking the quiz.`}}).filter(Boolean).sort((i,r)=>r.priority-i.priority).slice(0,4)}function ni(e){const t=e.filter(i=>!i.completed&&i.status==="urgent").sort((i,r)=>i.lessonId-r.lessonId),s=e.filter(i=>!i.completed&&i.status==="review").sort((i,r)=>i.lessonId-r.lessonId),n=e.filter(i=>!i.completed&&(i.status==="growing"||i.status==="mastered")).sort((i,r)=>i.lessonId-r.lessonId),a=e.filter(i=>i.completed&&(i.status==="urgent"||i.status==="review")).sort((i,r)=>i.mastery-r.mastery||i.lessonId-r.lessonId),o=e.filter(i=>i.completed&&(i.status==="growing"||i.status==="mastered")).sort((i,r)=>i.lessonId-r.lessonId);return[...t,...s,...n,...a,...o]}function ai(e,t=[],s=null){var c,u;const n=t.slice().sort((l,p)=>new Date(p.completedAt)-new Date(l.completedAt)),a=n[0]||null,o=n.length>0?Xt(n.map(l=>l.score/l.totalQuestions)):null;let i=0;const r=[];if(s||(i+=10,r.push("no diagnostic profile yet")),e.completionRate<40&&(i+=15,r.push("low lesson completion")),e.knowledgeGaps.length>=3&&(i+=20,r.push("several knowledge gaps remain open")),a){const l=a.score/a.totalQuestions;l<.5?(i+=25,r.push("latest quiz score below 50%")):l<.65&&(i+=12,r.push("latest quiz score needs support")),a.theta<-.75?(i+=25,r.push("ability estimate is trending low")):a.theta<-.25&&(i+=12,r.push("ability estimate suggests review"))}o!==null&&o<.6&&n.length>=2&&(i+=10,r.push("recent quiz trend is still below target"));const d=Math.min(100,i);return d>=60?{score:d,label:"High",badge:"danger",reasons:r,action:`Teacher check-in recommended. Start with ${((c=e.recommendedNext)==null?void 0:c.title)||"the weakest topic"} and review the revision queue.`}:d>=35?{score:d,label:"Moderate",badge:"warning",reasons:r,action:`Guide the learner through ${((u=e.recommendedNext)==null?void 0:u.title)||"the next recommended lesson"} and schedule a tutor session.`}:{score:d,label:"Low",badge:"success",reasons:r.length?r:["steady progress across current evidence"],action:"Keep the learner on the personalized path and use the tutor for stretch support."}}function Z({diagnostic:e=null,results:t=[],progressRecords:s=[]}={}){const n=new Set(s.map(m=>m.lessonId)),a=nn(e),o=Za(t),i=L.map(m=>{const g=a.get(m.id),v=t.filter(T=>T.lessonId===m.id).sort((T,j)=>new Date(j.completedAt)-new Date(T.completedAt)),f=o.get(m.id)||null,S=f?f.score/f.totalQuestions:null,b=v.length?Xt(v.map(T=>T.score/T.totalQuestions)):null,y=g?g.accuracy:null,I=n.has(m.id);let w=0,_=0;y!==null&&(w+=y*.35,_+=.35),S!==null&&(w+=S*.45,_+=.45),b!==null&&v.length>1&&(w+=b*.1,_+=.1),I&&(w+=.1,_+=.1);let B=_>0?w/_:.2;I&&_===0&&(B=.55),B=sn(B);const N=ei(B);let G="Continue building momentum on this topic.";return g&&g.accuracy<.5?G="The diagnostic found this topic needs early attention.":S!==null&&S<.6?G="Recent quiz results suggest a focused review here.":I||(G="This topic is ready to learn next in your path."),{lessonId:m.id,title:m.title,completed:I,mastery:B,masteryPercent:Ja(B),status:N,diagnosticScore:y,latestQuizScore:S,latestTheta:(f==null?void 0:f.theta)??null,attempts:v.length,recommendedFocus:G}}),r=ni(i),d=i.filter(m=>m.status==="urgent"||m.status==="review").sort((m,g)=>m.mastery-g.mastery).slice(0,3),c=i.filter(m=>m.status==="mastered"||m.status==="growing").sort((m,g)=>g.mastery-m.mastery).slice(0,3),u=si(i,t,e),l=ti(i),p=L.length>0?Math.round(n.size/L.length*100):0,h={lessonProfiles:i,recommendedSequence:r,recommendedNext:r.find(m=>!m.completed)||r[0]||null,knowledgeGaps:d,strengths:c,revisionQueue:u,readiness:l,completionRate:p,completedCount:n.size};return h.risk=ai(h,t,e),h}function ii(e,t){var s,n,a,o;return`
  ...
  `}function oi(e){return e.revisionQueue.length?`
  ...
  `}async function ci(){const e=P(),t=e?await J(e.id):[],s=new Set(t.map(i=>i.lessonId)),n=e?await ve(e.id):[],a=e?await ne(e.id):null,o=Z({diagnostic:a,results:n,progressRecords:t});return`
    ...
    <div class="container container--narrow view-enter lesson-page" style="padding-top: var(--space-8);">
      ...
      ${oi(o)}
      ${ri(o)}
      ${Ue(s.size,L.length,"Lessons completed")}

      <div class="lesson-list">
        ${L.map((i,r)=>{var p;const d=s.has(i.id),c=o.lessonProfiles.find(h=>h.lessonId===i.id),u=((p=o.recommendedNext)==null?void 0:p.lessonId)===i.id,l=o.knowledgeGaps.some(h=>h.lessonId===i.id);return`
  ...
  `}function di(e){q({onBack:()=>e("/")});const t=document.getElementById("btn-open-path");t&&t.addEventListener("click",async()=>{var u;const o=P(),i=o?await J(o.id):[],r=o?await ne(o.id):null,d=o?await ve(o.id):[],c=Z({diagnostic:r,results:d,progressRecords:i});e(`/lesson/${((u=c.recommendedNext)==null?void 0:u.lessonId)||1}`)});const s=document.getElementById("btn-open-tutor");s&&s.addEventListener("click",()=>e("/tutor"));const n=document.getElementById("btn-open-assessments");n&&n.addEventListener("click",()=>e("/assessments"));const a=document.getElementById("btn-open-diagnostic");a&&a.addEventListener("click",()=>e("/diagnostic")),document.querySelectorAll(".revision-queue__item, .adaptive-preview__item").forEach(o=>{o.addEventListener("click",i=>{const r=Number.parseInt(i.currentTarget.dataset.lessonId,10);e(`/lesson/${r}`)})}),document.querySelectorAll(".lesson-card").forEach(o=>{o.addEventListener("click",i=>{const r=Number.parseInt(i.currentTarget.dataset.id,10);e(`/lesson/${r}`)})})}async function li(e){var l;const t=P(),s=L.find(p=>p.id===e);if(!s)return'<div class="container" style="padding: 2rem;">Lesson not found.</div>';const n=L.indexOf(s),a=t?await ua(t.id,e):!1,o=Va[e],i=t?await J(t.id):[],r=t?await ve(t.id):[],d=t?await ne(t.id):null,u=Z({diagnostic:d,results:r,progressRecords:i}).lessonProfiles.find(p=>p.lessonId===e);return`
    ${M({title:"Lesson",showBack:!0,studentName:t==null?void 0:t.name})}

    <div class="container container--narrow view-enter lesson-page">
      ${Ue(n+1,L.length,`Lesson ${n+1} of ${L.length}`)}
...
Give only the short explanation:`}async function ki(e){const t={},s=e.filter(n=>!n.correct);for(const n of s){const a=n.options[n.selectedIndex],o=n.options[n.correctIndex];t[n.questionId]=await rn(n.questionId,n.stem,a,o,{preferCached:!0})}return t}let K=null,rt=null,xe=null,E=null,Oe=!1,et=null,xi=0;function cn(e=0){const t=Math.max(0,Math.round(e/1e3)),s=String(Math.floor(t/60)).padStart(2,"0"),n=String(t%60).padStart(2,"0");return`${s}:${n}`}function He(){et&&(window.clearInterval(et),et=null)}function gs(){const e=document.getElementById("question-timer");!e||!K||(e.textContent=cn(K.getCurrentElapsedMs()))}function $i(){He(),gs(),et=window.setInterval(gs,1e3)}function dn(e){return{source:e.source,text:e.aiText,practiceTip:e.practiceTip,usageCount:e.usageCount,reusedFromQuestionBank:e.reusedFromQuestionBank}}function ln(e){return e.correct?"Instant success feedback is ready.":e.feedbackLoading?navigator.onLine?"Generating a simple AI explanation and saving it for offline use...":"You are offline. Looking for a saved explanation on this device...":e.source==="ai"?"Live AI feedback is ready and saved for offline reuse.":e.source==="cache"?"Loaded from the saved feedback cache on this device.":e.source==="question-cache"?"Using a common saved explanation for this question while offline.":"Showing the built-in offline explanation."}function Ai(e){if(!E)return;E.aiText=e.text,E.source=e.source,E.practiceTip=e.practiceTip,E.usageCount=e.usageCount,E.reusedFromQuestionBank=e.reusedFromQuestionBank,E.feedbackLoading=!1;const t=document.getElementById("feedback-container");t&&(t.innerHTML=Zt(dn(E),!1));const s=document.getElementById("feedback-status");s&&(s.textContent=ln(E))}function Ci(e,t,s){const n=`feedback-${++xi}`;E&&(E.feedbackRequestId=n),rn(e.id,e.stem,t,s,{preferCached:!1}).then(a=>{!E||E.feedbackRequestId!==n||Ai(a)})}function Li(e){He(),rt=Number.parseInt(e,10),K=hi(rt),xe=K.next(),E=null,Oe=!1}function Ei(e){const t=Number.parseInt(e,10);(!K||rt!==t)&&Li(t)}function Ti(){He(),K=null,rt=null,xe=null,E=null,Oe=!1}function Bi(){if(!K||!xe)return'<div class="container">Error initializing quiz.</div>';const e=P(),t=xe;let s="";if(E){const n=E.aiText?Zt(dn(E),E.correct):'<div class="shimmer" style="height: 116px; width: 100%;"></div>';s=`
    ...
    `}else s=`
      ...
      ${Ue(t.questionNumber-1,t.totalQuestions,"Quiz progress")}
  ...
  `}function Di(e,t,s){if(q({onBack:()=>e(`/lesson/${s}`)}),E){He();const a=document.getElementById("btn-next-question");a&&a.addEventListener("click",async()=>{if(E=null,K.isFinished()){await vs(e,s);return}const o=K.next();if(!o){await vs(e,s);return}xe=o,t()});return}$i(),document.querySelectorAll(".option-btn").forEach(a=>{a.addEventListener("click",o=>{if(Oe)return;Oe=!0;const i=Number.parseInt(o.currentTarget.dataset.index,10);Mi(i,o.currentTarget,t)})})}function Mi(e,t,s){const n=K.answer(e),a=xe.question;if(He(),document.querySelectorAll(".option-btn").forEach(i=>{i.classList.add("option-btn--disabled"),i.disabled=!0}),n.correct)t.classList.add("option-btn--correct");else{t.classList.add("option-btn--incorrect");const i=document.getElementById(`option-${n.correctIndex}`);i&&i.classList.add("option-btn--highlight-correct")}E={questionId:a.id,stem:a.stem,correct:n.correct,studentAnswerText:a.options[e],correctAnswerText:a.options[n.correctIndex],aiText:n.correct?"Great work - you understood this concept.":null,source:n.correct?"system":null,practiceTip:n.correct?"Keep building on that idea in the next question.":null,usageCount:0,reusedFromQuestionBank:!1,feedbackLoading:!n.correct,feedbackRequestId:null,elapsedMs:n.elapsedMs,thetaAfter:n.thetaAfter,levelLabel:n.level.label},n.correct||Ci(a,E.studentAnswerText,E.correctAnswerText),setTimeout(()=>{Oe=!1,s()},1e3)}async function vs(e,t){const s=P(),n=K.getResults();if(!s){e("/lessons");return}const a=await pa({studentId:s.id,lessonId:Number.parseInt(t,10),...n});e(`/quiz-results/${a.id}`)}function Pt(e=0){const t=Math.max(0,Math.round(e/1e3)),s=String(Math.floor(t/60)).padStart(2,"0"),n=String(t%60).padStart(2,"0");return`${s}:${n}`}async function Ri(e){var d,c,u;const t=P(),s=await fe(),n=s.find(l=>l.id===Number.parseInt(e,10));if(!n)return'<div class="container">Result not found.</div>';const a=t?s.filter(l=>l.studentId===t.id):[],o=t?await ne(t.id):null,i=t?await J(t.id):[],r=Z({diagnostic:o,results:a,progressRecords:i});return`
    ...
    <div class="container container--narrow view-enter quiz-results">
      ...
      <div class="quiz-results__metrics">
        <div class="quiz-result-metric">
          ...
          <span class="quiz-result-metric__value">${Pt(n.totalTimeMs)}</span>
        </div>
        <div class="quiz-result-metric">
          <span class="quiz-result-metric__label">Average / question</span>
          <span class="quiz-result-metric__value">${Pt(n.averageTimeMs)}</span>
        </div>
        <div class="quiz-result-metric">
  ...
  `}function Pi(e,t){q({onBack:()=>e("/lessons")});const s=document.getElementById("btn-next-lesson"),n=document.getElementById("btn-open-tutor"),a=document.getElementById("btn-retry-quiz");fe().then(async o=>{const i=o.find(p=>p.id===Number.parseInt(t,10));if(!i)return;const r=P(),d=r?o.filter(p=>p.studentId===r.id):[],c=r?await ne(r.id):null,u=r?await J(r.id):[],l=Z({diagnostic:c,results:d,progressRecords:u});s&&s.addEventListener("click",()=>{var h;const p=(h=l.recommendedNext)==null?void 0:h.lessonId;e(p?`/lesson/${p}`:"/lessons")}),n&&n.addEventListener("click",()=>{e("/tutor")}),a&&a.addEventListener("click",()=>{e(`/quiz/${i.lessonId}`)}),qi(i.responses)})}async function qi(e){const t=document.getElementById("review-list");if(!t)return;t.innerHTML=e.map(n=>It(n,null)).join("");const s=await ki(e);t.innerHTML=e.map(n=>n.correct?It(n,{text:"Correct! You handled this concept well.",source:"system"}):It(n,s[n.questionId])).join("")}function It(e,t){const s=e.options[e.selectedIndex],n=e.options[e.correctIndex];let a="";return t?e.correct||(a=`
  ...
  `}const Ni="modulepreload",zi=function(e){return"/"+e},fs={},ji=function(t,s,n){let a=Promise.resolve();if(s&&s.length>0){let i=function(c){return Promise.all(c.map(u=>Promise.resolve(u).then(l=>({status:"fulfilled",value:l}),l=>({status:"rejected",reason:l}))))};document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),d=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));a=i(s.map(c=>{if(c=zi(c),c in fs)return;fs[c]=!0;const u=c.endsWith(".css"),l=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${l}`))return;const p=document.createElement("link");if(p.rel=u?"stylesheet":Ni,u||(p.as="script"),p.crossOrigin="",p.href=c,d&&p.setAttribute("nonce",d),document.head.appendChild(p),u)return new Promise((h,m)=>{p.addEventListener("load",h),p.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${c}`)))})}))}function o(i){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=i,window.dispatchEvent(r),!r.defaultPrevented)throw i}return a.then(i=>{for(const r of i||[])r.status==="rejected"&&o(r.reason);return t().catch(o)})};let St=null,bs=!1;async function un(){return St||(St=ji(()=>import("./chart-45xamTTr.js"),[]).then(e=>{const t=e.Chart;return bs||(t.register(...e.registerables),bs=!0),t})),St}function Oi(){return["Index Number,Full Name,Class,Gender,PIN","GES-B7-0101,Kwame Mensah,B7 — JHS 1A,Male,1234","GES-B7-0102,Ama Serwaa,B7 — JHS 1A,Female,5678","GES-B7-0103,Kofi Boateng,B7 — JHS 1A,Male,","GES-B7-0104,Abena Osei,B7 — JHS 1B,Female,9012","GES-B7-0105,Yaw Appiah,B7 — JHS 1B,Male,"].join(`
`)}function Qi(){const e=Oi(),t=new Blob([e],{type:"text/csv;charset=utf-8;"}),s=URL.createObjectURL(t),n=document.createElement("a");n.href=s,n.download="classconnect_sample_roster.csv",n.click(),URL.revokeObjectURL(s)}function Fi(e){const t=e.split(/\r?\n/)[0]||"",s=(t.match(/,/g)||[]).length,n=(t.match(/;/g)||[]).length,a=(t.match(/\t/g)||[]).length;return a>s&&a>n?"	":n>s?";":","}function Gi(e){const t=Fi(e),s=e.split(/\r?\n/).map(n=>n.trim()).filter(Boolean);return s.length<1?[]:s.map(n=>{const a=[];let o=!1,i="";for(let r=0;r<n.length;r+=1){const d=n[r];d==='"'?o=!o:d===t&&!o?(a.push(i.trim().replace(/^"|"$/g,"")),i=""):i+=d}return a.push(i.trim().replace(/^"|"$/g,"")),a})}function Le(e,t=[]){const s=e.map(n=>n.toLowerCase().replace(/[^a-z0-9]/g,""));for(const n of t){const a=n.toLowerCase().replace(/[^a-z0-9]/g,""),o=s.indexOf(a);if(o!==-1)return o}return-1}function Ui(e=""){const t=e.trim().toLowerCase();return t.startsWith("m")||t==="boy"?"Male":t.startsWith("f")||t==="girl"?"Female":"Unspecified"}function Hi(){return String(Math.floor(1e3+Math.random()*9e3))}function Wi(e,t=[],s=[],n=null){var S,b,y;const a=Gi(e);if(a.length<2)return{success:!1,error:"The CSV file must contain a header row and at least one student record.",validRecords:[],warnings:[],errors:[]};const o=a[0],i=Le(o,["fullname","name","studentname","learnername"]),r=Le(o,["indexnumber","indexno","id","admissionno","studentid"]),d=Le(o,["class","grade","stream","section","classstream"]),c=Le(o,["gender","sex"]),u=Le(o,["pin","password","code","logincode"]);if(i===-1&&r===-1)return{success:!1,error:'CSV header must include at least a "Full Name" or "Index Number" column.',validRecords:[],warnings:[],errors:[]};const l=[],p=[],h=[],m=new Set,g=new Set,v=new Map;t.forEach(I=>{v.set(I.name.toLowerCase().trim(),I.id),I.gradeLevel&&I.stream&&(v.set(`${I.gradeLevel} ${I.stream}`.toLowerCase().trim(),I.id),v.set(`${I.gradeLevel}-${I.stream}`.toLowerCase().trim(),I.id))});const f=n||((S=t[0])==null?void 0:S.id)||1;for(let I=1;I<a.length;I+=1){const w=a[I],_=i!==-1?(w[i]||"").trim():"",B=r!==-1?(w[r]||"").trim():"",N=d!==-1?(w[d]||"").trim():"",G=c!==-1?w[c]:"",T=u!==-1?(w[u]||"").trim():"";if(!_&&!B)continue;if(_.length<2&&!B){p.push(`Row ${I+1}: Student name "${_}" is too short.`);continue}let j=f,ue=((b=t.find(X=>X.id===f))==null?void 0:b.name)||"Default Class";if(N){const X=v.get(N.toLowerCase().trim());X?(j=X,ue=((y=t.find(zn=>zn.id===X))==null?void 0:y.name)||N):h.push(`Row ${I+1}: Class "${N}" not recognized. Assigned to ${ue}.`)}let ye=T,ns=!1;if((!ye||!/^\d{4}$/.test(ye))&&(ye=Hi(),ns=!0),B){if(m.has(B.toLowerCase())){p.push(`Row ${I+1}: Duplicate Index Number "${B}" found in CSV.`);continue}m.add(B.toLowerCase())}const as=`${_.toLowerCase()}::${j}`;_&&g.has(as)&&h.push(`Row ${I+1}: Student "${_}" appears multiple times in this class.`),_&&g.add(as);const Ke=s.find(X=>B&&X.indexNumber&&X.indexNumber.toLowerCase()===B.toLowerCase()||_&&X.name.toLowerCase()===_.toLowerCase()&&X.classId===j);l.push({rowNumber:I+1,name:_||B,indexNumber:B||null,classId:j,className:ue,gender:Ui(G),pin:ye,pinGenerated:ns,status:"active",isUpdate:!!Ke,existingId:(Ke==null?void 0:Ke.id)||null})}return{success:l.length>0,validRecords:l,errors:p,warnings:h,summary:{totalRows:a.length-1,validCount:l.length,errorCount:p.length,warningCount:h.length,newCount:l.filter(I=>!I.isUpdate).length,updateCount:l.filter(I=>I.isUpdate).length,autoPinsGenerated:l.filter(I=>I.pinGenerated).length}}}const Ki=3e4;let x=null,Me=[],me=null,ts=null,tt=null,st=null,Re=null,Pe=null,_e=null,nt=!1,$e=null,ee="all",ct="";function D(e=""){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Yi(e=[]){return e.length?e.reduce((t,s)=>t+s,0)/e.length:0}function qt(e=0){const t=Math.max(0,Math.round(e/1e3)),s=String(Math.floor(t/60)).padStart(2,"0"),n=String(t%60).padStart(2,"0");return`${s}:${n}`}function ss(e){return e?new Date(e).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}):"Not yet"}function Nt(e){var t;return((t=L.find(s=>s.id===e))==null?void 0:t.title)||`Lesson ${e}`}function Vi(e){const t={};return e.slice().sort((s,n)=>new Date(s.completedAt)-new Date(n.completedAt)).forEach(s=>{t[s.studentId]=s}),Object.values(t)}function Ji(e){const t=(e==null?void 0:e.lessonBreakdown)||[];return t.length?Math.round(Yi(t.map(s=>s.accuracy||0))*100):0}function Zi(e,t,s,n,a,o){const i=new Map(e.map(c=>[c.id,c])),r=new Map(a.map(c=>[c.id,c])),d=[];return t.forEach(c=>{var p;const u=((p=i.get(c.studentId))==null?void 0:p.name)||"Unknown learner",l=c.totalQuestions>0?Math.round(c.score/c.totalQuestions*100):0;d.push({type:"Quiz",tone:l>=70?"success":l>=50?"warning":"danger",title:`${u} completed ${Nt(c.lessonId)} quiz`,meta:`${l}% score · ${c.level||"No level"} · ${qt(c.totalTimeMs)}`,timestamp:c.completedAt})}),s.forEach(c=>{var l;const u=((l=i.get(c.studentId))==null?void 0:l.name)||"Unknown learner";d.push({type:"Progress",tone:"primary",title:`${u} completed ${Nt(c.lessonId)}`,meta:"Lesson completion saved to the local database.",timestamp:c.completedAt})}),n.forEach(c=>{var l;const u=((l=i.get(c.studentId))==null?void 0:l.name)||"Unknown learner";d.push({type:"Diagnostic",tone:"accent",title:`${u} completed the readiness diagnostic`,meta:`${Ji(c)}% average readiness across sampled lessons.`,timestamp:c.completedAt})}),a.forEach(c=>{d.push({type:"Assess",tone:"accent",title:`Published ${c.title}`,meta:`${c.questions.length} questions · ${c.objectiveCoverage.length} objectives covered.`,timestamp:c.createdAt})}),o.forEach(c=>{var g,v,f,S,b;const u=((g=i.get(c.studentId))==null?void 0:g.name)||"Unknown learner",l=((v=r.get(c.assessmentId))==null?void 0:v.title)||"an assessment",p=((f=c.integrity)==null?void 0:f.label)||"Low",h=((S=c.proctor)==null?void 0:S.label)||"Low",m=((b=c.grading)==null?void 0:b.percentage)??0;d.push({type:"Submit",tone:p==="High"||h==="High"?"warning":"success",title:`${u} submitted ${l}`,meta:`${m}% score · Integrity ${p} · Proctor ${h}`,timestamp:c.completedAt})}),d.sort((c,u)=>new Date(u.timestamp)-new Date(c.timestamp)).slice(0,8)}function Xi(e,t,s,n,a,o){const i=Vi(t),r={};n.slice().sort((w,_)=>new Date(_.completedAt)-new Date(w.completedAt)).forEach(w=>{r[w.studentId]||(r[w.studentId]=w)});const d=e.map(w=>{const _=t.filter(T=>T.studentId===w.id),B=s.filter(T=>T.studentId===w.id),N=r[w.id]||null,G=Z({diagnostic:N,results:_,progressRecords:B});return{student:w,results:_,progressRecords:B,diagnostic:N,profile:G}}),c=e.length>0?Math.round(s.length/(e.length*L.length)*100):0,u=i.length>0?Math.round(i.reduce((w,_)=>w+_.score/_.totalQuestions,0)/i.length*100):0,l=d.filter(w=>w.profile.risk.score>=60).length,p=e.length>0?Math.round(d.filter(w=>w.diagnostic).length/e.length*100):0,h={},m={};t.forEach(w=>{h[w.lessonId]=(h[w.lessonId]||0)+w.score/w.totalQuestions,m[w.lessonId]=(m[w.lessonId]||0)+1});const g=L.map(w=>m[w.id]?Math.round(h[w.id]/m[w.id]*100):0),v={Advanced:0,Proficient:0,Developing:0,Beginner:0};i.forEach(w=>{v[w.level]!==void 0&&(v[w.level]+=1)});const f={};t.forEach(w=>{w.responses.forEach(_=>{if(_.correct)return;const B=`${_.questionId}|${_.stem}|${_.options[_.selectedIndex]}`;f[B]=(f[B]||0)+1})});const S=Object.entries(f).map(([w,_])=>{const[B,N,G]=w.split("|");return{questionId:B,stem:N,answer:G,count:_}}).sort((w,_)=>_.count-w.count).slice(0,7),b=L.map(w=>{const _=d.map(B=>{var N;return((N=B.profile.lessonProfiles.find(G=>G.lessonId===w.id))==null?void 0:N.mastery)||0});return{lessonId:w.id,title:w.title,averageMastery:_.length?Math.round(_.reduce((B,N)=>B+N,0)/_.length*100):0}}),y=d.filter(w=>w.profile.risk.score>=35).sort((w,_)=>_.profile.risk.score-w.profile.risk.score).slice(0,6),I=Zi(e,t,s,n,a,o);return{students:e,results:t,progressRecords:s,diagnostics:n,assessments:a,assessmentSubmissions:o,studentProfiles:d,latestResults:i,recentActivity:I,summary:{totalStudents:e.length,averageScore:u,completionRate:c,studentsAtRisk:l,diagnosticCoverage:p,totalAssessments:a.length,totalAssessmentSubmissions:o.length},charts:{lessonLabels:L.map(w=>`Lesson ${w.id}`),lessonScoreData:g,levelCounts:v,misconceptions:S},interventionQueue:y,masterySnapshot:b}}async function pn(){const[e,t,s,n,a,o,i]=await Promise.all([se(),Y(),fe(),ut(),pt(),Ge(),be()]),r=e.map(m=>({...m,studentCount:t.filter(g=>g.classId===m.id).length})),d=ee==="all"?t:t.filter(m=>String(m.classId)===String(ee)),c=new Set(d.map(m=>m.id)),u=ee==="all"?s:s.filter(m=>c.has(m.studentId)),l=ee==="all"?n:n.filter(m=>c.has(m.studentId)),p=ee==="all"?a:a.filter(m=>c.has(m.studentId)),h=ee==="all"?i:i.filter(m=>c.has(m.studentId));return x=Xi(d,u,l,p,o,h),x.classes=r,x.allStudents=t,x.selectedClassId=ee,ts=new Date().toISOString(),x}function eo(e){return`
        ...
        ${e.recentActivity.length>0?e.recentActivity.map(t=>`
          <div class="activity-item">
            <div class="activity-item__top">
              ...
              <span class="activity-item__time">${ss(t.timestamp)}</span>
            </div>
  ...
  `}function mn(e){if(!e.students.length)return`
    ...
    `;const t=ct.trim().toLowerCase(),s=t?e.students.filter(n=>n.name&&n.name.toLowerCase().includes(t)||n.indexNumber&&n.indexNumber.toLowerCase().includes(t)):e.students;return s.length?`
  ...
  `:`
      <div class="empty-state dashboard-empty">
        ...
        <p class="empty-state__text">No students matched "${D(ct)}". Try searching for another name or index number.</p>
      </div>
    `}function hn(e){const{summary:t}=e;return`
    <div class="dashboard-header">
      ...
      <div class="dashboard-live-bar">
        <div class="dashboard-live-bar__item"><strong>Last updated:</strong> <span id="dashboard-live-updated">${ss(ts)}</span></div>
    ...
    <div class="stat-grid">
      ${Ie("Students",t.totalStudents,"Total Students","primary",`${e.results.length} quizzes recorded`)}
      ${Ie("Average",`${t.averageScore}%`,"Average Score","accent","Latest quiz per student")}
      ${Ie("Progress",`${t.completionRate}%`,"Completion Rate","success",`${e.progressRecords.length} lesson completions logged`)}
      ${Ie("Support",t.studentsAtRisk,"High Risk Learners",t.studentsAtRisk>0?"danger":"success","Prediction score 60+")}
      ${Ie("Diagnostic",`${t.diagnosticCoverage}%`,"Diagnostic Coverage",t.diagnosticCoverage<100?"accent":"success","Students with readiness profiles")}
      ${Ie("Assess",t.totalAssessments,"Published Assessments",t.totalAssessments>0?"primary":"accent",`${t.totalAssessmentSubmissions} assessment submissions logged`)}
    </div>
    ...
    <div class="student-section">
      ...
      <div class="roster-filter-bar">
        <input type="search" id="roster-search-input" class="input input--sm roster-search-input" placeholder="Search roster by name or index #..." value="${D(ct)}">
      </div>
  ...
  `}function Te(){return!!document.getElementById("dashboard-live-root")}function gn(){Me.forEach(e=>e.destroy()),Me=[]}function vn(e){const t=document.getElementById("btn-export-csv"),s=document.getElementById("btn-open-assessment-lab"),n=document.getElementById("btn-open-lab-monitor"),a=document.getElementById("btn-open-lesson-editor"),o=document.getElementById("btn-open-question-editor"),i=document.getElementById("btn-refresh-dashboard"),r=document.getElementById("class-filter-select"),d=document.getElementById("btn-manage-classes"),c=document.getElementById("btn-import-roster"),u=document.getElementById("btn-print-slips"),l=document.getElementById("roster-search-input");t&&t.addEventListener("click",async()=>{const h=await Aa();Ys(h),C("Data exported successfully","success")}),s&&s.addEventListener("click",()=>{e("/assessment-lab")}),n&&n.addEventListener("click",()=>e("/lab-monitor")),a&&a.addEventListener("click",()=>e("/lesson-editor")),o&&o.addEventListener("click",()=>e("/question-editor"));const p=document.getElementById("btn-open-gradebook");p&&p.addEventListener("click",()=>{e("/gradebook")}),i&&i.addEventListener("click",()=>{W("manual")}),r&&r.addEventListener("change",h=>{ee=h.target.value,W("manual")}),d&&d.addEventListener("click",()=>{oo()}),c&&c.addEventListener("click",()=>{ro()}),u&&u.addEventListener("click",()=>{co()}),l&&l.addEventListener("input",h=>{ct=h.target.value;const m=document.getElementById("roster-table-container");m&&x&&(m.innerHTML=mn(x),ys())}),ys()}function ys(){document.querySelectorAll(".student-row").forEach(e=>{e.addEventListener("click",t=>{const s=Number.parseInt(t.currentTarget.dataset.id,10);lo(s)})}),document.querySelectorAll(".btn-quick-reset-pin").forEach(e=>{e.addEventListener("click",t=>{t.stopPropagation();const s=Number.parseInt(t.currentTarget.dataset.id,10);fn(s)})}),document.querySelectorAll(".btn-quick-report-card").forEach(e=>{e.addEventListener("click",t=>{t.stopPropagation();const s=Number.parseInt(t.currentTarget.dataset.id,10);$e&&$e(`/report-card/${s}`)})})}async function W(e="live-update"){if(!Te()){Qe();return}if(_e)return nt=!0,_e;const t=document.getElementById("btn-refresh-dashboard"),s=(t==null?void 0:t.textContent)||"Refresh Now",n=document.getElementById("dashboard-live-status-text");return t&&(t.disabled=!0,t.textContent="Refreshing..."),n&&(n.innerHTML="<strong>Sync mode:</strong> Refreshing live analytics from the local database..."),_e=(async()=>{await pn();const a=document.getElementById("dashboard-live-root");if(!a)return;a.innerHTML=hn(x),vn($e),await bn();const o=document.getElementById("dashboard-live-updated");o&&(o.textContent=ss(ts));const i=document.getElementById("dashboard-live-status-text");if(i){const r=e==="manual"?"Manual refresh complete.":"Live sync updated after a local database change.";i.innerHTML=`<strong>Sync mode:</strong> ${r}`}})().catch(a=>{console.error(a),C("Dashboard refresh failed. Please try again.","error")}).finally(()=>{t&&(t.disabled=!1,t.textContent=s),_e=null,nt&&(nt=!1,W("queued"))}),_e}function to(){tt=ta(()=>{if(!Te()){Qe();return}W("database-event")}),Re=()=>{document.visibilityState==="visible"&&Te()&&W("visibility")},Pe=()=>{Te()&&W("focus")},document.addEventListener("visibilitychange",Re),window.addEventListener("focus",Pe),st=window.setInterval(()=>{if(!Te()){Qe();return}document.visibilityState==="visible"&&W("heartbeat")},Ki)}function Qe(){tt&&(tt(),tt=null),st&&(window.clearInterval(st),st=null),Re&&(document.removeEventListener("visibilitychange",Re),Re=null),Pe&&(window.removeEventListener("focus",Pe),Pe=null),gn(),me&&(me.destroy(),me=null),_e=null,nt=!1}async function so(){return await pn(),`
  ...
  `}function no(e){Qe(),$e=e,q({onBack:()=>e("/"),onSettings:ao,onLogout:()=>{ka(),e("/")}}),vn(e),bn(),to()}function ao(){var o;const e=Ae()||"",t=Wt()||"",s=`
  ...
  `;le("Dashboard Settings",s,[{label:"Cancel",variant:"btn--ghost"},{label:"Save",variant:"btn--primary",onClick:async()=>{const i=document.getElementById("settings-api-key"),r=document.getElementById("settings-teacher-pin"),d=(i==null?void 0:i.value.trim())||"",c=(r==null?void 0:r.value.trim())||"";return c&&!/^\d{4}$/.test(c)?(C("Teacher PIN must stay 4 digits.","error"),!1):(await js(d),c&&await Os(c),C("Settings saved","success"),!0)}}]),(o=document.getElementById("btn-backup-download"))==null||o.addEventListener("click",async()=>{await Ea(),C("School database backup downloaded.","success")});const n=document.getElementById("btn-backup-restore"),a=document.getElementById("backup-restore-file");n&&a&&(n.addEventListener("click",()=>a.click()),a.addEventListener("change",i=>{var c;const r=(c=i.target.files)==null?void 0:c[0];if(!r)return;const d=new FileReader;d.onload=async u=>{try{const l=JSON.parse(u.target.result);confirm("Are you sure you want to restore data from this backup? Any new records will be merged.")&&(await Ta(l,"merge"),C("School database restored successfully!","success"),W("manual"))}catch(l){console.error(l),C("Failed to restore backup: "+l.message,"error")}},d.readAsText(r)}))}async function fn(e){const s=((x==null?void 0:x.students)||await Y()).find(o=>o.id===e);if(!s)return;const n=String(Math.floor(1e3+Math.random()*9e3)),a=`
  ...
  `;le("Manage School Classes",n,[{label:"Close",variant:"btn--ghost"}]);const a=document.getElementById("form-create-class");a&&a.addEventListener("submit",async o=>{var p,h,m,g,v;o.preventDefault();const i=((p=document.getElementById("new-class-grade"))==null?void 0:p.value)||"B7",r=((h=document.getElementById("new-class-stream"))==null?void 0:h.value.trim())||"A",d=((m=document.getElementById("new-class-year"))==null?void 0:m.value.trim())||"2026/2027",c=((g=document.getElementById("new-class-term"))==null?void 0:g.value)||"Term 1",u=((v=document.getElementById("new-class-teacher"))==null?void 0:v.value.trim())||"Class Teacher",l=await aa({name:`${i} — JHS ${r}`,gradeLevel:i,stream:r,academicYear:d,term:c,teacherName:u});C(`Class "${l.name}" created successfully!`,"success"),W("manual")})}async function ro(){var c;const e=await se(),t=await Y(),n=`
    <div>
  ...
  `;let a=null;le("Bulk Import Student Roster",n,[{label:"Cancel",variant:"btn--ghost"},{label:"Commit & Import Roster",variant:"btn--primary",onClick:async()=>{if(!a||!a.validRecords.length)return C("Please choose a valid CSV file first.","error"),!1;const u=await da(a.validRecords);return C(`Import complete! Created ${u.created.length} new student(s) and updated ${u.updated.length}.`,"success"),W("manual"),!0}}],{modalClass:"modal--wide"}),(c=document.getElementById("btn-download-sample-csv"))==null||c.addEventListener("click",()=>{Qi(),C("Sample roster CSV downloaded.","info")});const o=document.getElementById("import-dropzone"),i=document.getElementById("import-file-input");o&&i&&(o.addEventListener("click",()=>i.click()),o.addEventListener("dragover",u=>{u.preventDefault(),o.classList.add("import-dropzone--active")}),o.addEventListener("dragleave",()=>o.classList.remove("import-dropzone--active")),o.addEventListener("drop",u=>{var p;u.preventDefault(),o.classList.remove("import-dropzone--active");const l=(p=u.dataTransfer.files)==null?void 0:p[0];l&&r(l)}),i.addEventListener("change",u=>{var p;const l=(p=u.target.files)==null?void 0:p[0];l&&r(l)}));function r(u){const l=new FileReader;l.onload=p=>{var g,v;const h=(g=p.target)==null?void 0:g.result;if(typeof h!="string")return;const m=Number.parseInt((v=document.getElementById("import-default-class"))==null?void 0:v.value,10)||null;a=Wi(h,e,t,m),d(a)},l.readAsText(u)}function d(u){const l=document.getElementById("import-preview-area"),p=document.getElementById("import-summary-bar"),h=document.getElementById("import-preview-body");if(!u.success){C(u.error||"Unable to parse CSV file.","error");return}l.style.display="block",p.innerHTML=`
    ...
    `).join("")}}async function co(){var d;const e=await se(),t=await Y(),s=ee!=="all"?Number.parseInt(ee,10):(d=e[0])==null?void 0:d.id,n=`
  ...
  `;le("Print Student Login Slips",n,[{label:"Close",variant:"btn--ghost"}],{modalClass:"modal--wide"});const a=document.getElementById("slips-container"),o=document.getElementById("print-class-select"),i=document.getElementById("btn-trigger-print");function r(c){const u=c==="all"?t:t.filter(l=>String(l.classId)===String(c));if(!u.length){a.innerHTML='<div class="insight-empty no-print">No students found in this class.</div>';return}a.innerHTML=u.map(l=>{const p=e.find(m=>m.id===l.classId),h=p?p.name:"JHS Computing";return`
      ...
      `}).join("")}r(s),o==null||o.addEventListener("change",c=>{r(c.target.value)}),i==null||i.addEventListener("click",()=>{window.print()})}async function lo(e){var g,v,f,S,b;const t=(x==null?void 0:x.students)||await Y(),s=(x==null?void 0:x.classes)||await se(),n=(x==null?void 0:x.results)||await fe(),a=(x==null?void 0:x.progressRecords)||await ut(),o=(x==null?void 0:x.diagnostics)||await pt(),i=t.find(y=>y.id===e);if(!i)return;const r=s.find(y=>y.id===i.classId),d=n.filter(y=>y.studentId===e).sort((y,I)=>new Date(y.completedAt)-new Date(I.completedAt)),c=o.filter(y=>y.studentId===e).sort((y,I)=>new Date(I.completedAt)-new Date(y.completedAt))[0]||null,u=Z({diagnostic:c,results:d,progressRecords:a.filter(y=>y.studentId===e)}),l=d.at(-1),p=d.length>0?Math.round(d.reduce((y,I)=>y+I.score/I.totalQuestions,0)/d.length*100):0;a.filter(y=>y.studentId===e).length,d.flatMap(y=>y.responses.map(I=>({...I,lessonId:y.lessonId,completedAt:y.completedAt}))).sort((y,I)=>new Date(I.answeredAt||I.completedAt)-new Date(y.answeredAt||y.completedAt));const m=`
    <div class="student-detail">
      ...
      <div class="student-detail__stats">
        ...
        <div class="student-detail__stat">
          <div class="student-detail__stat-value">${l?qt(l.averageTimeMs):"00:00"}</div>
          ...
          <div class="student-detail__quiz-list">
            ${d.length>0?d.slice().reverse().map(y=>`
              <div class="student-detail__quiz-entry">
                <div>
                  <div style="font-weight: var(--font-weight-semibold); font-size: var(--font-size-sm);">Lesson ${y.lessonId}: ${Nt(y.lessonId)}</div>
  ...
  `;le("Student Profile",m,[{label:"Close",variant:"btn--ghost"}],{modalClass:"modal--wide"}),(f=document.getElementById("btn-modal-report-card"))==null||f.addEventListener("click",()=>{var y;(y=document.querySelector(".modal-backdrop"))==null||y.remove(),$e&&$e(`/report-card/${e}`)}),(S=document.getElementById("btn-modal-reset-pin"))==null||S.addEventListener("click",()=>{fn(e)}),(b=document.getElementById("btn-modal-edit-student"))==null||b.addEventListener("click",()=>{io(e)}),d.length>0&&setTimeout(()=>{uo(d)},0)}async function bn(){if(!x)return;gn();const e=await un();e.defaults.color="#94A3B8",e.defaults.borderColor="rgba(148, 163, 184, 0.1)";const t=document.getElementById("chart-scores");t&&Me.push(new e(t,{type:"bar",data:{labels:x.charts.lessonLabels,datasets:[{label:"Average Score (%)",data:x.charts.lessonScoreData,backgroundColor:"rgba(99, 102, 241, 0.8)",borderRadius:4}]},options:{responsive:!0,maintainAspectRatio:!1,scales:{y:{beginAtZero:!0,max:100}}}}));const s=document.getElementById("chart-levels");s&&Me.push(new e(s,{type:"doughnut",data:{labels:Object.keys(x.charts.levelCounts),datasets:[{data:Object.values(x.charts.levelCounts),backgroundColor:["#34D399","#818CF8","#FBBF24","#FB7185"],borderWidth:0,cutout:"70%"}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"right"}}}}));const n=document.getElementById("chart-misconceptions");if(n){const a=x.charts.misconceptions.map(i=>i.stem),o=x.charts.misconceptions.map(i=>i.count);Me.push(new e(n,{type:"bar",data:{labels:a,datasets:[{label:"Times missed",data:o,backgroundColor:"rgba(244, 63, 94, 0.75)",borderRadius:6}]},options:{indexAxis:"y",responsive:!0,maintainAspectRatio:!1,plugins:{tooltip:{callbacks:{label(i){const r=x.charts.misconceptions[i.dataIndex];return`${i.raw} misses - common wrong answer: ${r.answer}`}}}},scales:{x:{beginAtZero:!0,ticks:{precision:0}},y:{ticks:{callback(i,r){return`Q${r+1}`}}}}}}))}}async function uo(e){const t=document.getElementById("student-theta-chart");if(!t)return;const s=await un();me&&(me.destroy(),me=null);const n=e.map(o=>`L${o.lessonId}`),a=e.map(o=>o.theta);me=new s(t,{type:"line",data:{labels:n,datasets:[{label:"Theta",data:a,borderColor:"#818CF8",backgroundColor:"rgba(129, 140, 248, 0.15)",fill:!0,tension:.35,pointRadius:4}]},options:{responsive:!0,maintainAspectRatio:!1,scales:{y:{min:-3,max:3}},plugins:{legend:{display:!1}}}})}function po(){return new Map(L.map(e=>{const t=ot.filter(s=>s.lessonId===e.id).sort((s,n)=>{const a=Math.abs(s.difficulty)-Math.abs(n.difficulty);return a!==0?a:n.discrimination-s.discrimination});return[e.id,t]}))}function mo(e,t){return e>=.75&&t===0?"Ready to Accelerate":e>=.5?"Foundations Growing":"Needs Guided Support"}function ws(e){return L.map(t=>{const s=e.get(t.id)||[],n=s.filter(i=>i.correct).length,a=s.length,o=a>0?n/a:0;return{lessonId:t.id,lessonTitle:t.title,correct:n,attempted:a,accuracy:o}})}function ho(){const e=po(),t=L.map(g=>{var v;return(v=e.get(g.id))==null?void 0:v[0]}).filter(Boolean),s=new Map(L.map(g=>[g.id,(e.get(g.id)||[]).slice(1)])),n=new Set,a=[];let o=0,i=null,r=[],d=!1,c=!1;function u(){const g=new Map;for(const f of a){const S=g.get(f.lessonId)||[];S.push(f),g.set(f.lessonId,S)}r=ws(g).sort((f,S)=>f.accuracy!==S.accuracy?f.accuracy-S.accuracy:f.lessonId-S.lessonId).slice(0,3).map(f=>(s.get(f.lessonId)||[]).find(b=>!n.has(b.id))||null).filter(Boolean),d=!0}function l(){if(c)return null;let g=null;if(t.length>0?g=t.shift():(d||u(),g=r.shift()||null),!g)return c=!0,null;n.add(g.id),i=g,o+=1;const v=L.find(f=>f.id===g.lessonId);return{question:g,questionNumber:o,totalQuestions:8,lessonId:g.lessonId,lessonTitle:(v==null?void 0:v.title)||`Lesson ${g.lessonId}`,phase:o<=5?"coverage":"follow-up"}}function p(g){if(!i)return null;const v=g===i.correctIndex,f={questionId:i.id,lessonId:i.lessonId,stem:i.stem,options:i.options,selectedIndex:g,correctIndex:i.correctIndex,correct:v};return a.push(f),i=null,{correct:v,correctIndex:f.correctIndex}}function h(){const g=new Map;for(const w of a){const _=g.get(w.lessonId)||[];_.push(w),g.set(w.lessonId,_)}const v=ws(g),f=v.filter(w=>w.accuracy<.5),S=v.filter(w=>w.accuracy>=.75),b=a.filter(w=>w.correct).length,y=a.length,I=y>0?b/y:0;return{score:b,totalQuestions:y,readiness:mo(I,f.length),generationMethod:"adaptive diagnostic",lessonBreakdown:v,knowledgeGaps:f,strengths:S,responses:a}}function m(){return c}return{next:l,answer:p,getResults:h,isFinished:m}}let ce=null,H=null,Fe=!1;function go(){ce=ho(),H=ce.next(),Fe=!1}function vo(){(!ce||!H)&&go()}function yn(){ce=null,H=null,Fe=!1}function fo(){if(!ce||!H)return'<div class="container">Error loading diagnostic assessment.</div>';const e=P();return`
    ...
    <div class="container container--narrow view-enter diagnostic-page" style="padding-top: var(--space-6);">
      <div class="card card--glass diagnostic-hero">
        ...
        <div class="diagnostic-hero__meta">
          ...
          <span class="badge badge--accent">${H.phase==="coverage"?"Checking broad coverage":"Following up on weak areas"}</span>
          <span class="badge badge--primary">${H.lessonTitle}</span>
        </div>
      </div>
      ...
      <div class="diagnostic-stage">
        <div class="diagnostic-stage__header">
          <div>
            <div class="diagnostic-stage__label">Question ${H.questionNumber}</div>
            <h2 class="diagnostic-stage__title">${H.lessonTitle}</h2>
          </div>
          <span class="badge badge--neutral">${H.phase==="coverage"?"Coverage pass":"Adaptive follow-up"}</span>
        </div>

        ${Ue(H.questionNumber-1,H.totalQuestions,"Diagnostic progress")}
  ...
  `}function bo(e,t){q({onBack:()=>e("/lessons")}),document.querySelectorAll(".option-btn").forEach(s=>{s.addEventListener("click",async n=>{if(Fe)return;Fe=!0;const a=Number.parseInt(n.currentTarget.dataset.index,10);await yo(a,n.currentTarget,e,t)})})}async function yo(e,t,s,n){const a=ce.answer(e);if(document.querySelectorAll(".option-btn").forEach(r=>{r.classList.add("option-btn--disabled"),r.disabled=!0}),a.correct)t.classList.add("option-btn--correct");else{t.classList.add("option-btn--incorrect");const r=document.getElementById(`option-${a.correctIndex}`);r&&r.classList.add("option-btn--highlight-correct")}await new Promise(r=>setTimeout(r,500));const i=ce.next();if(!i){await wo(s);return}H=i,Fe=!1,await n()}async function wo(e){const t=P(),s=ce.getResults();if(!t){e("/student-login");return}const n=await ma({studentId:t.id,...s});yn(),e(`/diagnostic-results/${n.id}`)}const Io="https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent";function So(e){const t=e.objectives.slice(0,2).join("; "),s=(e.keyTerms||[]).slice(0,3).map(n=>`${n.word}: ${n.definition}`).join("; ");return`${e.title}. Objectives: ${t}. Key terms: ${s}`}function wn(e){var o;const t=e.knowledgeGaps.map(i=>i.title).join(", ")||"none identified",s=e.strengths.map(i=>i.title).join(", ")||"still emerging",n=((o=e.recommendedNext)==null?void 0:o.title)||"Lesson 1",a=e.revisionQueue.map(i=>`${i.title} (${i.reason})`).join("; ")||"none";return[`Readiness: ${e.readiness.label}.`,`Completion rate: ${e.completionRate}%.`,`Knowledge gaps: ${t}.`,`Strengths: ${s}.`,`Recommended next lesson: ${n}.`,`Revision queue: ${a}.`].join(" ")}function _o(e){const t=e.toLowerCase();return L.find(s=>t.includes(s.title.toLowerCase())?!0:(s.keyTerms||[]).some(n=>t.includes(n.word.toLowerCase())))||null}function ko(e){var n,a,o;const t=((n=e.strengths[0])==null?void 0:n.title)||"your earliest lessons",s=((a=e.knowledgeGaps[0])==null?void 0:a.title)||((o=e.recommendedNext)==null?void 0:o.title)||"the next lesson";return`You are showing the most confidence in ${t}. Focus next on ${s}, then use the AI Tutor to clear up anything that still feels confusing. Small, steady review sessions will move your readiness up quickly.`}function xo(e,t){var i,r;const s=_o(e),n=t.knowledgeGaps[0],a=t.recommendedNext,o=e.toLowerCase();if(o.includes("next")||o.includes("study")||o.includes("path"))return`Your best next step is ${(a==null?void 0:a.title)||"the next lesson in your path"}. It is recommended because ${n?`${n.title} still needs review`:"it keeps your momentum going"}. After that, revisit one item from your revision queue before taking the quiz.`;if(s){const d=(i=s.keyTerms)==null?void 0:i[0],c=(r=s.objectives)==null?void 0:r[0];return`${s.title} is mainly about ${(c==null?void 0:c.toLowerCase())||"this topic area"}. Start with this idea: ${d?`${d.word} means ${d.definition}`:"focus on the core lesson objective first"}. Then compare it with your own words and try one practice question before moving on.`}return o.includes("struggling")||o.includes("stuck")||o.includes("hard")?`It looks like ${(n==null?void 0:n.title)||"one of your current topics"} needs a slower, more guided review. Break it into two parts: reread the lesson objectives first, then ask me one specific question about a term or idea that is still unclear.`:`I remember your current path is strongest when we keep things focused. Start with ${(a==null?void 0:a.title)||"your next recommended lesson"}, and if a concept feels confusing, ask me about one term or one example at a time so we can unpack it together.`}async function In(e){var s,n,a,o,i,r;const t=Ae();if(!t||!navigator.onLine)return null;try{const d=await fetch(`${Io}?key=${t}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:[{parts:[{text:e}]}],generationConfig:{temperature:.6,maxOutputTokens:300,topP:.9}}),signal:AbortSignal.timeout(12e3)});if(!d.ok)return null;const c=await d.json();return((r=(i=(o=(a=(n=(s=c==null?void 0:c.candidates)==null?void 0:s[0])==null?void 0:n.content)==null?void 0:a.parts)==null?void 0:o[0])==null?void 0:i.text)==null?void 0:r.trim())||null}catch{return null}}async function $o(e,t,s){const n=["You are a warm, concise learning coach for Basic 7 Computing.",`Student: ${e.name}.`,`Diagnostic readiness: ${t.readiness}.`,wn(s),"Write exactly 3 supportive sentences for the student.","Sentence 1: celebrate one strength.","Sentence 2: explain the most important gap to focus on next.","Sentence 3: give a short action plan using the tutor and the next lesson."].join(`
`),a=await In(n);return{text:a||ko(s),source:a?"ai":"fallback"}}async function Ao({student:e,message:t,history:s=[],profile:n}){const a=L.map(So).join(`
`),o=s.slice(-8).map(d=>`${d.role}: ${d.content}`).join(`
`),i=["You are ClassConnect Tutor, a supportive Basic 7 Computing tutor.",`Student: ${e.name}.`,wn(n),"Use the profile and memory below. Keep answers clear, age-appropriate, and practical.","If the learner asks what to study next, recommend the personalized path.","If the learner asks about a concept, explain it simply and connect it to one lesson.","Respond in 2 short paragraphs maximum.","Lesson references:",a,"Conversation memory:",o||"No prior messages yet.",`Student message: ${t}`].join(`
`),r=await In(i);return{text:r||xo(t,n),source:r?"ai":"fallback"}}function Is(e,t,s){return e.length?e.map(n=>`
  ...
  `).join(""):`<div class="insight-empty">${t}</div>`}async function Co(e){var d;const t=P(),s=await Fs(Number.parseInt(e,10));if(!t||!s||s.studentId!==t.id)return'<div class="container" style="padding: 2rem;">Diagnostic result not found.</div>';const n=await ne(t.id),a=await J(t.id),o=await ve(t.id),i=Z({diagnostic:n,results:o,progressRecords:a}),r=s.totalQuestions>0?Math.round(s.score/s.totalQuestions*100):0;return`
      ...
      <div class="diagnostic-grid">
        <div class="card">
          ...
          <div class="insight-pill-list">
            ${Is(s.knowledgeGaps,"No urgent gaps were detected in the diagnostic.","warning")}
          </div>
        </div>
        ...
        <div class="card">
          ...
          <div class="insight-pill-list">
            ${Is(s.strengths,"Your strengths will appear here as you build more evidence.","success")}
          </div>
        </div>
      </div>
  ...
  `}function Lo(e,t){q({onBack:()=>e("/lessons")});const s=document.getElementById("btn-open-path"),n=document.getElementById("btn-open-tutor"),a=document.getElementById("btn-retake-diagnostic");Fs(Number.parseInt(t,10)).then(async o=>{const i=P();if(!i||!o)return;const r=await ne(i.id),d=await J(i.id),c=await ve(i.id),u=Z({diagnostic:r,results:c,progressRecords:d});s&&s.addEventListener("click",()=>{var m;e(`/lesson/${((m=u.recommendedNext)==null?void 0:m.lessonId)||1}`)}),n&&n.addEventListener("click",()=>{e("/tutor")}),a&&a.addEventListener("click",()=>{e("/diagnostic")}),document.querySelectorAll(".path-preview__item").forEach(m=>{m.addEventListener("click",g=>{const v=Number.parseInt(g.currentTarget.dataset.lessonId,10);e(`/lesson/${v}`)})});const l=await $o(i,o,u),p=document.getElementById("diagnostic-insight"),h=document.getElementById("diagnostic-insight-source");p&&(p.textContent=l.text),h&&(h.textContent=l.source==="ai"?"AI generated":"Offline-ready insight",h.className=`badge ${l.source==="ai"?"badge--primary":"badge--neutral"}`)})}const Eo=["What should I study next?","Explain RAM and storage in simple words.","Help me review my weakest topic."];let z={studentId:null,messages:[],sending:!1};function To(e=""){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}async function Bo(e){if(z.studentId===e)return;const t=await ga(e);z={studentId:e,messages:(t==null?void 0:t.messages)||[],sending:!1}}function Do(){return z.messages.length?z.messages.map(e=>`
    <div class="chat-bubble chat-bubble--${e.role}">
      <div class="chat-bubble__role">${e.role==="assistant"?"AI Tutor":"You"}</div>
      <div class="chat-bubble__text">${To(e.content)}</div>
  ...
  `).join(""):`
    ...
    `}async function Mo(){var o,i,r,d;const e=P();if(!e)return'<div class="container" style="padding: 2rem;">Student session not found.</div>';await Bo(e.id);const t=await ne(e.id),s=await J(e.id),n=await ve(e.id),a=Z({diagnostic:t,results:n,progressRecords:s});return`
  ...
  `}function Ro(e,t){q({onBack:()=>e("/lessons")});const s=document.getElementById("tutor-form"),n=document.getElementById("tutor-input"),a=document.getElementById("btn-clear-chat"),o=document.getElementById("tutor-thread");o&&(o.scrollTop=o.scrollHeight),a&&a.addEventListener("click",async()=>{const i=P();i&&(await va(i.id),z={studentId:i.id,messages:[],sending:!1},await t())}),document.querySelectorAll(".tutor-prompt").forEach(i=>{i.addEventListener("click",async r=>{const d=r.currentTarget.dataset.prompt;d&&await Ss(d,t)})}),s&&n&&s.addEventListener("submit",async i=>{i.preventDefault();const r=n.value.trim();if(!r){C("Type a question for the tutor first.","error");return}await Ss(r,t)})}async function Ss(e,t){const s=P();if(!s||z.sending)return;const n=await ne(s.id),a=await J(s.id),o=await ve(s.id),i=Z({diagnostic:n,results:o,progressRecords:a}),r={role:"user",content:e,createdAt:new Date().toISOString()};z={...z,sending:!0,messages:[...z.messages,r]},await ls(s.id,z.messages),await t();const d=await Ao({student:s,message:e,history:z.messages,profile:i});z={...z,sending:!1,messages:[...z.messages,{role:"assistant",content:d.text,source:d.source,createdAt:new Date().toISOString()}]},await ls(s.id,z.messages),await t()}const Po="https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent",_s={1:{prompt:"Write a JavaScript function named `isPortableComputer(type)` that returns `true` for portable computers like a laptop, tablet, or smartphone, and `false` for a desktop or server.",starterCode:`function isPortableComputer(type) {
  // your code here
}
...
`}};function Sn(e=""){return e.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")}function _t(e,t){const s=e.slice(),n=[];for(;s.length>0&&n.length<t;)n.push(s.shift());return n}function zt(e){const t=L.filter(s=>e.includes(s.id));return t.length>0?t:L.slice(0,2)}function qo(e=""){const t=e.match(/```json\s*([\s\S]*?)```/i);if(t!=null&&t[1])return t[1].trim();const s=e.indexOf("{"),n=e.lastIndexOf("}");return s>=0&&n>s?e.slice(s,n+1):e}function No(e,t,s){const n=["mcq","short","code"].includes(e.type)?e.type:"short",a=s.includes(e.lessonId)?e.lessonId:s[0],o=Number.isFinite(e.maxScore)?e.maxScore:n==="mcq"?1:5,i=Array.isArray(e.rubric)&&e.rubric.length>0?e.rubric.map(r=>({criterion:r.criterion||"Quality",description:r.description||"Addresses the prompt clearly.",points:Number.isFinite(r.points)?r.points:2,keywords:Array.isArray(r.keywords)?r.keywords:[]})):[{criterion:"Accuracy",description:"Uses correct subject knowledge.",points:o,keywords:[]}];return{id:`GEN-Q${t+1}`,type:n,lessonId:a,objective:e.objective||"Generated from lesson objectives",prompt:e.prompt||e.stem||`Generated question ${t+1}`,options:n==="mcq"&&Array.isArray(e.options)&&e.options.length===4?e.options:void 0,correctIndex:n==="mcq"&&Number.isInteger(e.correctIndex)?e.correctIndex:void 0,starterCode:n==="code"?e.starterCode||"":void 0,answerKey:e.answerKey||"",sampleSolution:e.sampleSolution||"",rubric:i,maxScore:o}}function zo(e,t,s){const n=(e.keyTerms||[]).slice(0,3),a=n.map(i=>i.word.toLowerCase()),o=`In 3-5 sentences, ${t.charAt(0).toLowerCase()}${t.slice(1)}. Use at least one correct computing term from this lesson.`;return{id:`SA-Q${s+1}`,type:"short",lessonId:e.id,objective:t,prompt:o,answerKey:n.map(i=>`${i.word}: ${i.definition}`).join(" "),rubric:[{criterion:"Concept accuracy",description:"The response explains the idea correctly.",points:3,keywords:a},{criterion:"Use of subject vocabulary",description:"The response uses at least one correct computing term.",points:1,keywords:a},{criterion:"Clarity",description:"The response is easy to follow and stays on task.",points:1,keywords:[]}],maxScore:5}}function jo(e,t,s){const n=_s[e.id]||_s[5];return{id:`CODE-Q${s+1}`,type:"code",lessonId:e.id,objective:t,prompt:`${n.prompt}

Learning objective: ${t}`,starterCode:n.starterCode,answerKey:n.sampleSolution,sampleSolution:n.sampleSolution,rubric:[{criterion:"Correct logic",description:"The code follows the expected rule from the lesson.",points:3,keywords:n.keyConcepts},{criterion:"Programming structure",description:"The answer uses a function, return value, and clear condition or lookup.",points:2,keywords:["function","return"]}],maxScore:5}}function Oo(e,t){return{id:`MCQ-Q${t+1}`,type:"mcq",lessonId:e.lessonId,objective:"Check core understanding of the lesson objective.",prompt:e.stem,options:e.options,correctIndex:e.correctIndex,answerKey:e.options[e.correctIndex],rubric:[{criterion:"Correct answer",description:"Selects the correct option.",points:1,keywords:[]}],maxScore:1}}function Qo(e){const t=zt(e.lessonIds),s=t.flatMap(h=>h.objectives.map(m=>({lesson:h,objective:m}))),n=s.length>0?s:L.slice(0,1).flatMap(h=>h.objectives.map(m=>({lesson:h,objective:m}))),a=n.map(h=>({lessonId:h.lesson.id,lessonTitle:h.lesson.title,objective:h.objective})),o=ot.filter(h=>e.lessonIds.includes(h.lessonId)).sort((h,m)=>m.discrimination-h.discrimination||h.difficulty-m.difficulty),i=_t(n,e.shortAnswerCount||0),r=_t(n.slice().reverse(),e.codingCount||0),d=_t(o,e.mcqCount||0).map(Oo),c=i.map((h,m)=>zo(h.lesson,h.objective,m)),u=r.map((h,m)=>jo(h.lesson,h.objective,m)),l=[...d,...c,...u].map((h,m)=>({...h,id:`${Sn(e.title||"assessment")}-q${m+1}`})),p=l.length;return{title:e.title||"Generated Assessment",subject:"Basic 7 Computing",generatedBy:"fallback",published:!0,lessonIds:t.map(h=>h.id),objectiveCoverage:a,durationMinutes:e.durationMinutes||Math.max(15,p*4),advancedFeature:"Objective Coverage Map",createdAt:new Date().toISOString(),questions:l}}async function Fo(e){var o,i,r,d,c;const t=Ae();if(!t||!navigator.onLine)return null;const n=zt(e.lessonIds).map(u=>[`Lesson ${u.id}: ${u.title}`,`Objectives: ${u.objectives.join("; ")}`,`Key terms: ${(u.keyTerms||[]).map(l=>`${l.word}=${l.definition}`).join("; ")}`].join(`
`)).join(`
...
`);try{const u=await fetch(`${Po}?key=${t}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:[{parts:[{text:a}]}],generationConfig:{temperature:.7,maxOutputTokens:1200,topP:.9}}),signal:AbortSignal.timeout(15e3)});if(!u.ok)return null;const l=await u.json(),p=(c=(d=(r=(i=(o=l==null?void 0:l.candidates)==null?void 0:o[0])==null?void 0:i.content)==null?void 0:r.parts)==null?void 0:d[0])==null?void 0:c.text;if(!p)return null;const h=JSON.parse(qo(p));if(!Array.isArray(h.questions)||h.questions.length===0)return null;const m=h.questions.map((g,v)=>No(g,v,e.lessonIds));return{title:h.title||e.title||"Generated Assessment",subject:"Basic 7 Computing",generatedBy:"ai",published:!0,lessonIds:e.lessonIds,objectiveCoverage:Array.isArray(h.objectiveCoverage)&&h.objectiveCoverage.length>0?h.objectiveCoverage:zt(e.lessonIds).flatMap(g=>g.objectives.map(v=>({lessonId:g.id,lessonTitle:g.title,objective:v}))),durationMinutes:e.durationMinutes||Math.max(15,m.length*4),advancedFeature:"Objective Coverage Map",createdAt:new Date().toISOString(),questions:m.map((g,v)=>({...g,id:`${Sn(e.title||"assessment")}-q${v+1}`}))}}catch{return null}}function Go(){return L.map(e=>({lessonId:e.id,title:e.title,objectives:e.objectives}))}async function Uo(e){var n;const t={title:((n=e.title)==null?void 0:n.trim())||"Assessment Blueprint",lessonIds:Array.isArray(e.lessonIds)&&e.lessonIds.length>0?e.lessonIds:[1,2],mcqCount:Math.max(0,Number.parseInt(e.mcqCount,10)||0),shortAnswerCount:Math.max(0,Number.parseInt(e.shortAnswerCount,10)||0),codingCount:Math.max(0,Number.parseInt(e.codingCount,10)||0),durationMinutes:Math.max(10,Number.parseInt(e.durationMinutes,10)||20)};return await Fo(t)||Qo(t)}function Be(e){return e.length?e.reduce((t,s)=>t+s,0)/e.length:0}function kt(e,t=2){return Math.round(e*10**t)/10**t}function Ho(e,t){const s=t.map(r=>{var d;return{...r,totalNormalized:(d=r.grading)!=null&&d.maxScore?r.grading.totalScore/r.grading.maxScore:0}}),n=s.slice().sort((r,d)=>d.totalNormalized-r.totalNormalized),a=Math.max(1,Math.ceil(n.length/3)),o=n.slice(0,a),i=n.slice(-a);return e.questions.map(r=>{const d=s.map(m=>{var g,v;return(v=(g=m.grading)==null?void 0:g.questionScores)==null?void 0:v.find(f=>f.questionId===r.id)}).filter(Boolean),c=Be(d.map(m=>m.normalizedScore)),u=Be(o.map(m=>{var g,v,f;return(f=(v=(g=m.grading)==null?void 0:g.questionScores)==null?void 0:v.find(S=>S.questionId===r.id))==null?void 0:f.normalizedScore}).filter(m=>typeof m=="number")),l=Be(i.map(m=>{var g,v,f;return(f=(v=(g=m.grading)==null?void 0:g.questionScores)==null?void 0:v.find(S=>S.questionId===r.id))==null?void 0:f.normalizedScore}).filter(m=>typeof m=="number")),p=u-l;let h="Healthy";return c<.25?h="Too Hard":c>.85?h="Too Easy":p<.15&&(h="Weak Discriminator"),{questionId:r.id,type:r.type,prompt:r.prompt,objective:r.objective,difficultyIndex:kt(c),discriminationIndex:kt(p),meanScore:kt(Be(d.map(m=>m.score||0))),status:h,submissionCount:d.length}})}function _n(e,t){const s=Ho(e,t),n=t.length>0?Math.round(Be(t.map(i=>{var r;return((r=i.grading)==null?void 0:r.percentage)||0}))):0,a=t.filter(i=>{var r;return((r=i.integrity)==null?void 0:r.label)==="High"}).length,o=t.filter(i=>{var r;return((r=i.proctor)==null?void 0:r.label)==="High"}).length;return{assessmentId:e.id,title:e.title,generatedBy:e.generatedBy,submissionCount:t.length,averagePercentage:n,flaggedIntegrityCount:a,flaggedProctorCount:o,itemAnalysis:s}}function xt(e,t){return e.filter(s=>s.type===t).length}function Wo(){return Go().map(t=>`
  ...
  `).join("")}function Ko(e,t){return e.length?e.map(s=>{const n=t.filter(o=>o.assessmentId===s.id),a=_n(s,n);return`
      <div class="card assessment-admin-card">
        <div class="assessment-admin-card__header">
          ...
          <div class="assessment-admin-card__badges">
            <span class="badge badge--primary">${xt(s.questions,"mcq")} MCQ</span>
            <span class="badge badge--accent">${xt(s.questions,"short")} Short</span>
            <span class="badge badge--warning">${xt(s.questions,"code")} Code</span>
          </div>
        </div>
    ...
    `}function ks(e=""){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}async function Yo(e){const t=await Ge(),s=await be(),n=await Y(),a=t.find(c=>c.id===e);if(!a)return;const o=s.filter(c=>c.assessmentId===a.id),i=_n(a,o),r=o.filter(c=>{var u,l;return((u=c.integrity)==null?void 0:u.label)!=="Low"||((l=c.proctor)==null?void 0:l.label)!=="Low"}).map(c=>{var l,p,h,m,g;const u=n.find(v=>v.id===c.studentId);return`
        <tr>
      ...
      <div class="analysis-modal__section">
        ...
        <div class="analysis-modal__chips">
          ${a.objectiveCoverage.map(c=>`
            <span class="badge badge--neutral">${ks(c.lessonTitle||`Lesson ${c.lessonId}`)}: ${ks(c.objective)}</span>
          `).join("")}
        </div>
      </div>
  ...
  `;le(a.title,d,[{label:"Close",variant:"btn--ghost"}],{modalClass:"modal--wide"})}async function Vo(){const e=(await Ge()).slice().sort((s,n)=>new Date(n.createdAt)-new Date(s.createdAt)),t=await be();return`
  ...
  `}function Jo(e){q({onBack:()=>e("/dashboard")});const t=document.getElementById("assessment-builder-form");t&&t.addEventListener("submit",async s=>{var r,d,c,u,l;s.preventDefault();const n=[...document.querySelectorAll('input[name="lesson-id"]:checked')].map(p=>Number.parseInt(p.value,10)).filter(Boolean),a={title:((r=document.getElementById("assessment-title"))==null?void 0:r.value)||"",durationMinutes:((d=document.getElementById("assessment-duration"))==null?void 0:d.value)||"25",mcqCount:((c=document.getElementById("assessment-mcq-count"))==null?void 0:c.value)||"0",shortAnswerCount:((u=document.getElementById("assessment-short-count"))==null?void 0:u.value)||"0",codingCount:((l=document.getElementById("assessment-code-count"))==null?void 0:l.value)||"0",lessonIds:n},o=Number.parseInt(a.mcqCount,10)+Number.parseInt(a.shortAnswerCount,10)+Number.parseInt(a.codingCount,10);if(n.length===0){C("Choose at least one lesson for the blueprint.","error");return}if(o<=0){C("Add at least one question to the assessment.","error");return}const i=t.querySelector('button[type="submit"]');i&&(i.disabled=!0,i.textContent="Generating...");try{const p=await Uo(a);await fa(p),C(`Assessment published with ${p.questions.length} questions.`,"success"),await e("/assessment-lab")}catch(p){console.error(p),C("Assessment generation failed. Please try again.","error"),i&&(i.disabled=!1,i.textContent="Generate and Publish Assessment")}}),document.querySelectorAll(".btn-view-analysis").forEach(s=>{s.addEventListener("click",async n=>{const a=Number.parseInt(n.currentTarget.dataset.assessmentId,10);await Yo(a)})})}async function Zo(){const e=P(),t=(await Ge()).filter(n=>n.published!==!1).sort((n,a)=>new Date(a.createdAt)-new Date(n.createdAt)),s=e?await Gs(e.id):[];return`
  ...
  `}function Xo(e){q({onBack:()=>e("/lessons")}),document.querySelectorAll(".btn-start-assessment").forEach(t=>{t.addEventListener("click",s=>{const n=Number.parseInt(s.currentTarget.dataset.assessmentId,10);e(`/assessment/${n}`)})}),document.querySelectorAll(".btn-view-assessment-result").forEach(t=>{t.addEventListener("click",s=>{const n=Number.parseInt(s.currentTarget.dataset.submissionId,10);e(`/assessment-results/${n}`)})})}function kn(){return new Date().toISOString()}function er(e,t={}){return{type:e,detail:t,timestamp:kn()}}function tr({onEvent:e=null}={}){const t=[],s=[],n=new Map;let a=null;function o(p,h={}){const m=er(p,h);t.push(m),e==null||e(m)}function i(p,h,m,g){p.addEventListener(h,m,g),s.push(()=>p.removeEventListener(h,m,g))}async function r(){try{!document.fullscreenElement&&document.documentElement.requestFullscreen&&await document.documentElement.requestFullscreen()}catch{o("fullscreen-request-failed")}}async function d(){a=Date.now(),await r(),i(document,"visibilitychange",()=>{document.hidden&&o("tab-hidden")}),i(window,"blur",()=>{o("window-blur")}),i(document,"fullscreenchange",()=>{document.fullscreenElement||o("fullscreen-exit")}),i(document,"contextmenu",p=>{p.preventDefault(),o("context-menu-open")}),["copy","cut","paste"].forEach(p=>{i(document,p,h=>{h.preventDefault(),o(`${p}-attempt`)})}),i(document,"keydown",p=>{(p.key==="F12"||p.ctrlKey&&["c","v","x","p","s","u"].includes(p.key.toLowerCase())||p.ctrlKey&&p.shiftKey&&["i","j","c"].includes(p.key.toLowerCase()))&&(p.preventDefault(),o("blocked-shortcut",{key:p.key}))}),window.onbeforeunload=()=>"Assessment still in progress.",o("proctor-started")}function c(p,h){const m=(h||"").length,g=n.get(p)||{length:0,updatedAt:Date.now()},v=Date.now(),f=m-g.length,S=v-g.updatedAt;f>=80&&S<1500&&o("burst-typing",{questionId:p,deltaLength:f,deltaTime:S}),n.set(p,{length:m,updatedAt:v})}function u(){const p=t.reduce((m,g)=>(m[g.type]=(m[g.type]||0)+1,m),{}),h=Math.min(100,(p["fullscreen-exit"]||0)*18+(p["tab-hidden"]||0)*16+(p["window-blur"]||0)*12+(p["paste-attempt"]||0)*12+(p["copy-attempt"]||0)*8+(p["cut-attempt"]||0)*8+(p["blocked-shortcut"]||0)*7+(p["burst-typing"]||0)*10+(p["context-menu-open"]||0)*6);return{startedAt:a?new Date(a).toISOString():null,endedAt:kn(),durationMs:a?Date.now()-a:0,anomalyScore:h,label:h>=60?"High":h>=30?"Moderate":"Low",counts:p,events:t}}async function l(){s.splice(0).forEach(p=>p()),window.onbeforeunload=null;try{document.fullscreenElement&&document.exitFullscreen&&await document.exitFullscreen()}catch{}return o("proctor-stopped"),u()}return{start:d,stop:l,summarize:u,logEvent:o,trackTextEntry:c}}const sr="https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent";function qe(e,t,s){return Math.max(t,Math.min(s,e))}function nr(e,t=2){return Math.round(e*10**t)/10**t}function ar(e=""){return e.toLowerCase().replace(/[^a-z0-9\s]/g," ").split(/\s+/).filter(Boolean)}function ir(e,t=[]){return t.length?t.reduce((s,n)=>e.includes(String(n).toLowerCase())?s+1:s,0):0}function or(e){return e.filter(Boolean).join(" ")}async function rr(e){var s,n,a,o,i;const t=Ae();if(!t||!navigator.onLine)return null;try{const r=await fetch(`${sr}?key=${t}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:[{parts:[{text:e}]}],generationConfig:{temperature:.3,maxOutputTokens:400,topP:.85}}),signal:AbortSignal.timeout(12e3)});if(!r.ok)return null;const d=await r.json(),c=(i=(o=(a=(n=(s=d==null?void 0:d.candidates)==null?void 0:s[0])==null?void 0:n.content)==null?void 0:a.parts)==null?void 0:o[0])==null?void 0:i.text;if(!c)return null;const u=c.includes("{")?c.slice(c.indexOf("{"),c.lastIndexOf("}")+1):c;return JSON.parse(u)}catch{return null}}function cr(e,t){var c;const s=e.maxScore||((c=e.rubric)==null?void 0:c.reduce((u,l)=>u+l.points,0))||5,n=t.trim();if(!n)return{score:0,maxScore:s,rubricBreakdown:(e.rubric||[]).map(u=>({criterion:u.criterion,score:0,maxScore:u.points,evidence:"No evidence yet."})),feedback:"No response was submitted for this question.",source:"fallback"};const a=ar(n),o=/function|return|if|const|let|=>/i.test(n),i=(e.rubric||[]).map(u=>{var m,g;const l=ir(a,u.keywords),p=(m=u.keywords)!=null&&m.length?l/u.keywords.length:.6;let h=(g=u.keywords)!=null&&g.length?Math.round(qe(p,0,1)*u.points):Math.ceil(u.points*.6);return e.type==="code"&&o&&/function|return/i.test(n)&&/Programming structure/i.test(u.description)&&(h=Math.max(h,Math.ceil(u.points*.75))),h=qe(h,0,u.points),{criterion:u.criterion,score:h,maxScore:u.points,evidence:l>0?`Matched ${l} expected concept${l===1?"":"s"}.`:"Only partial evidence of the expected concept."}});let r=i.reduce((u,l)=>u+l.score,0);a.length>24&&r<s&&(r=Math.min(s,r+1));const d=or([r>=s*.8?"Strong response.":"This response shows some understanding but still needs refinement.",e.type==="code"?"Check that the code logic matches the lesson rule and that the function returns the expected values.":"Use more precise lesson vocabulary and include the key concept directly in your explanation."]);return{score:qe(r,0,s),maxScore:s,rubricBreakdown:i,feedback:d,source:"fallback"}}async function dr(e,t){var o;const s=e.maxScore||((o=e.rubric)==null?void 0:o.reduce((i,r)=>i+r.points,0))||5,n=["You are grading a Basic 7 Computing assessment.","Return valid JSON only with keys: score, feedback, rubricBreakdown.",`Question type: ${e.type}`,`Prompt: ${e.prompt}`,`Sample answer: ${e.sampleSolution||e.answerKey||""}`,`Rubric: ${JSON.stringify(e.rubric||[])}`,`Student response: ${t}`,`Maximum score: ${s}`].join(`
`),a=await rr(n);return a&&Number.isFinite(a.score)?{score:qe(Math.round(a.score),0,s),maxScore:s,rubricBreakdown:Array.isArray(a.rubricBreakdown)&&a.rubricBreakdown.length>0?a.rubricBreakdown.map(i=>({criterion:i.criterion||"Quality",score:qe(Math.round(i.score||0),0,Number.isFinite(i.maxScore)?i.maxScore:s),maxScore:Number.isFinite(i.maxScore)?i.maxScore:s,evidence:i.evidence||""})):[],feedback:a.feedback||"AI grading completed.",source:"ai"}:cr(e,t)}function lr(e,t){const s=Number.parseInt(t==null?void 0:t.selectedIndex,10)===e.correctIndex;return{score:s?e.maxScore||1:0,maxScore:e.maxScore||1,rubricBreakdown:[{criterion:"Correct answer",score:s?e.maxScore||1:0,maxScore:e.maxScore||1,evidence:s?"Correct option selected.":"Incorrect option selected."}],feedback:s?"Correct. You selected the best answer for this concept.":`Review this concept and compare your answer with the correct option: ${e.answerKey}.`,source:"system"}}async function ur({assessment:e,answers:t}){const s=[];for(const c of e.questions){const u=t.find(h=>h.questionId===c.id)||{};let l=null;c.type==="mcq"?l=lr(c,u):l=await dr(c,u.responseText||"");const p=l.maxScore>0?l.score/l.maxScore:0;s.push({questionId:c.id,prompt:c.prompt,lessonId:c.lessonId,objective:c.objective,type:c.type,score:l.score,maxScore:l.maxScore,normalizedScore:nr(p),feedback:l.feedback,rubricBreakdown:l.rubricBreakdown,gradingSource:l.source,flaggedForReview:c.type!=="mcq"&&l.source==="fallback"&&p>=.4&&p<=.7,answerPreview:c.type==="mcq"?u.selectedIndex:u.responseText||""})}const n=s.reduce((c,u)=>c+u.score,0),a=s.reduce((c,u)=>c+u.maxScore,0),o=a>0?Math.round(n/a*100):0,i=s.filter(c=>c.normalizedScore<.6).map(c=>({lessonId:c.lessonId,objective:c.objective,questionId:c.questionId,reason:c.feedback})),r=s.filter(c=>c.normalizedScore>=.8).map(c=>({lessonId:c.lessonId,objective:c.objective,questionId:c.questionId})),d=i.slice(0,4).map(c=>{var u;return{lessonId:c.lessonId,objective:c.objective,action:`Review this objective again and retry a similar ${((u=s.find(l=>l.questionId===c.questionId))==null?void 0:u.type)||"assessment"} question.`}});return{totalScore:n,maxScore:a,percentage:o,questionScores:s,weakObjectives:i,strengths:r,remediationPlan:d}}function V(e,t=2){return Math.round(e*10**t)/10**t}function ke(e=""){return e.toLowerCase().replace(/[^a-z0-9\s]/g," ").split(/\s+/).filter(Boolean)}function pr(e=""){return e.split(/[.!?]+/).map(t=>t.trim()).filter(Boolean)}function te(e){return e.length?e.reduce((t,s)=>t+s,0)/e.length:0}function mr(e){if(e.length<2)return 0;const t=te(e);return te(e.map(s=>(s-t)**2))}function xs(e,t){const s=new Set(e),n=new Set(t),a=[...s].filter(i=>n.has(i)).length,o=new Set([...s,...n]).size;return o>0?a/o:0}function hr(e){if(!e.length)return 0;const t=new Map;return e.forEach(s=>{t.set(s,(t.get(s)||0)+1)}),[...t.values()].reduce((s,n)=>{const a=n/e.length;return s-a*Math.log2(a)},0)}function xn(e){const t=ke(e),s=pr(e),n=s.map(l=>ke(l).length).filter(Boolean),a=new Set(t).size,o=t.length>0?a/t.length:0,i=n.length>0?te(n):t.length,r=n.length>1?mr(n)/Math.max(1,i):0,d=hr(t),c=t.length>0?2**d:0,u=(e.match(/\b(overall|in conclusion|therefore|moreover|furthermore|additionally)\b/gi)||[]).length;return{tokenCount:t.length,sentenceCount:s.length,lexicalDiversity:V(o),averageSentenceLength:V(i),burstiness:V(r),perplexityProxy:V(c),templatePhraseCount:u}}function $n(e){return typeof e.responseText=="string"?e.responseText.trim():""}function gr(e=[]){const t=e.flatMap(n=>n.answers||[]).map($n).filter(n=>n.length>0),s=t.map(xn);return{texts:t,avgLexicalDiversity:te(s.map(n=>n.lexicalDiversity)),avgSentenceLength:te(s.map(n=>n.averageSentenceLength))}}function vr({answers:e,priorSubmissions:t=[]}){const s=e.filter(b=>b.type==="short"||b.type==="code").map(b=>({questionId:b.questionId,type:b.type,text:$n(b)})).filter(b=>b.text.length>0),n=s.map(b=>({...b,metrics:xn(b.text)})),a=gr(t),o=te(n.map(b=>b.metrics.lexicalDiversity)),i=te(n.map(b=>b.metrics.averageSentenceLength)),r=te(n.map(b=>b.metrics.burstiness)),d=te(n.map(b=>b.metrics.perplexityProxy)),c=n.reduce((b,y)=>b+y.metrics.templatePhraseCount,0),u=[];for(let b=0;b<n.length;b+=1)for(let y=b+1;y<n.length;y+=1)u.push(xs(ke(n[b].text),ke(n[y].text)));const l=te(u),p=a.texts.length>0?Math.abs(o-a.avgLexicalDiversity)+Math.abs(i-a.avgSentenceLength)/20:0,h=a.texts.length>0&&s.length>0?Math.max(...s.map(b=>Math.max(...a.texts.map(y=>xs(ke(b.text),ke(y))),0)),0):0;let m=0;const g=[],v=[];if(s.length===0)return{score:0,label:"Low",reasons:["No open-ended writing to analyze."],metrics:{lexicalDiversity:0,averageSentenceLength:0,burstiness:0,perplexityProxy:0,internalSimilarity:0,historicalOverlap:0},flaggedSegments:v};o>.62&&r<1.2&&(m+=18,g.push("Writing is unusually uniform across responses.")),d>35&&r<1.4&&(m+=16,g.push("Perplexity proxy suggests highly polished and predictable wording.")),c>=2&&(m+=10,g.push("Several template-like transition phrases were reused.")),l>.45&&(m+=18,g.push("Multiple answers reuse very similar vocabulary patterns.")),p>.35&&(m+=22,g.push("Writing style differs noticeably from the student’s earlier responses.")),h>.75&&(m+=20,g.push("One or more answers overlap heavily with earlier saved writing.")),n.forEach(b=>{b.metrics.burstiness<.5&&b.metrics.tokenCount>30&&v.push({questionId:b.questionId,reason:"Low burstiness and long response length."})});const f=Math.min(100,Math.round(m)),S=f>=65?"High":f>=35?"Moderate":"Low";return g.length||g.push("Writing patterns look reasonably consistent."),{score:f,label:S,reasons:g,metrics:{lexicalDiversity:V(o),averageSentenceLength:V(i),burstiness:V(r),perplexityProxy:V(d),internalSimilarity:V(l),historicalOverlap:V(h),styleShift:V(p)},flaggedSegments:v}}const jt="cc_lab_room",$s=new Set;function fr(){var e,t;return((t=(e=globalThis.crypto)==null?void 0:e.randomUUID)==null?void 0:t.call(e))||`lab-${Date.now()}-${Math.random().toString(36).slice(2)}`}function ht(){const e=new URLSearchParams(window.location.search).get("lab");return e&&localStorage.setItem(jt,e),e||localStorage.getItem(jt)||""}function br(){const e=fr();return localStorage.setItem(jt,e),e}function An(e=ht()){const t=new URL("/student-login",window.location.origin);return t.searchParams.set("lab",e),t.toString()}function Cn(e){return e&&$s.add(e),ht(),()=>$s.delete(e)}function Ln(e,t={}){return ht(),!1}function Ot(e,t={}){return Ln("status",{...t})}function $t(e,t={}){return Ln("control",{...t})}let A=null,dt=null,re=new Map,de=!1,O=null,Ne=null,ae=0,pe=!1,Ve=null;function En(e=0){const t=String(Math.floor(e/60)).padStart(2,"0"),s=String(e%60).padStart(2,"0");return`${t}:${s}`}function As(e=""){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Tn(e){return e.type==="mcq"?{questionId:e.id,type:e.type,selectedIndex:null}:{questionId:e.id,type:e.type,responseText:e.type==="code"&&e.starterCode||""}}function Bn(e,t){if(!t)return!1;if(e.type==="mcq")return Number.isInteger(t.selectedIndex);const s=(t.responseText||"").trim();return!(!s||e.type==="code"&&s===(e.starterCode||"").trim())}function yr(e,t,s){return e.type==="mcq"?`
    ...
    <div class="assessment-question card">
      ...
      >${As((s==null?void 0:s.responseText)||"")}</textarea>
    </div>
  `}function Dn(){return(A==null?void 0:A.questions.map(e=>re.get(e.id)||Tn(e)))||[]}function Cs(){const e=document.getElementById("assessment-session-timer");e&&(e.textContent=En(ae))}function gt(){Ne&&(window.clearInterval(Ne),Ne=null)}async function wr(e){const t=Number.parseInt(e,10);A&&dt===t||(A=await ba(t),dt=t,re=new Map(((A==null?void 0:A.questions)||[]).map(s=>[s.id,Tn(s)])),de=!1,O=null,ae=((A==null?void 0:A.durationMinutes)||20)*60,gt(),pe=!1)}function Ir(){gt(),O&&O.stop(),A=null,dt=null,re=new Map,de=!1,O=null,ae=0,pe=!1}async function Sr(e){if(!A||de)return;const t=P();O=tr({onEvent:s=>{["fullscreen-exit","tab-hidden","window-blur"].includes(s.type)&&Ot("Taking Assessment",{studentId:t==null?void 0:t.id,studentName:t==null?void 0:t.name,detail:`${A.title}: ${s.type.replaceAll("-"," ")}`,alert:!0})}}),await O.start(),Ot("Taking Assessment",{studentId:t==null?void 0:t.id,studentName:t==null?void 0:t.name,detail:`${A.title} (Q1/${A.questions.length})`}),de=!0,ae=(A.durationMinutes||20)*60,await e()}async function Qt(e){if(!A||pe)return;pe=!0,gt();const t=P();if(!t){pe=!1,e("/student-login");return}try{const s=Dn().map(d=>{const c=A.questions.find(u=>u.id===d.questionId);return!c||c.type==="mcq"?d:{...d,responseText:Bn(c,d)?d.responseText:""}}),n=await Gs(t.id),a=await ur({assessment:A,answers:s}),o=vr({answers:s,priorSubmissions:n}),i=O?await O.stop():{anomalyScore:0,label:"Low",counts:{},events:[]},r=await ya({assessmentId:A.id,studentId:t.id,answers:s,grading:a,integrity:o,proctor:i});Ot("Completed",{studentId:t.id,studentName:t.name,detail:`${A.title} submitted`,alert:i.label!=="Low"}),A=null,dt=null,re=new Map,de=!1,O=null,ae=0,pe=!1,e(`/assessment-results/${r.id}`)}catch(s){console.error(s),C("Unable to submit the assessment right now.","error"),pe=!1}}function _r(e){!de||Ne||!A||(Cs(),Ne=window.setInterval(async()=>{ae=Math.max(0,ae-1),Cs(),ae===0&&(gt(),C("Time is up. Submitting your assessment now.","info"),await Qt(e))},1e3))}function kr(){return{completed:Dn().filter(s=>{const n=A==null?void 0:A.questions.find(a=>a.id===s.questionId);return n?Bn(n,s):!1}).length,total:(A==null?void 0:A.questions.length)||0}}function xr(){var n;const e=P();if(!A)return'<div class="container" style="padding: 2rem;">Assessment not found.</div>';const t=kr(),s=(n=O==null?void 0:O.summarize)==null?void 0:n.call(O);return de?`
    ...
    <div class="container container--narrow view-enter assessment-session-page">
      <div class="card card--glass assessment-session-topbar">
        <div>
          ...
          <h1 class="assessment-session-topbar__title">${A.title}</h1>
        </div>
        <div class="assessment-session-topbar__meta">
          <span class="badge badge--warning" id="assessment-session-timer">${En(ae)}</span>
      ...
      ${Ue(t.completed,t.total,"Assessment completion")}

      <form id="assessment-session-form" class="assessment-session-form">
        ${A.questions.map((a,o)=>yr(a,o,re.get(a.id))).join("")}
  ...
  `:`
      ...
      <div class="container container--narrow view-enter assessment-session-page">
        <div class="card card--glass assessment-start-card">
          ...
          <h1 class="assessment-hero__title">${A.title}</h1>
          ...
          <div class="assessment-start-card__grid">
            <div class="assessment-start-card__metric">
              <span class="assessment-start-card__value">${A.durationMinutes}</span>
              <span class="assessment-start-card__label">Minutes</span>
            </div>
            <div class="assessment-start-card__metric">
              <span class="assessment-start-card__value">${A.questions.length}</span>
              <span class="assessment-start-card__label">Questions</span>
            </div>
            <div class="assessment-start-card__metric">
              <span class="assessment-start-card__value">${A.objectiveCoverage.length}</span>
    ...
    `}function $r(e,t,s){if(Ve==null||Ve(),Ve=Cn(a=>{a.type==="control"&&a.action==="lock-screens"&&(document.querySelectorAll("input, textarea, button").forEach(o=>{o.closest("#main-nav")||(o.disabled=!0)}),C("The teacher has locked this assessment screen.","warning")),a.type==="control"&&a.action==="force-submit"&&Qt(e)}),q({onBack:()=>e("/assessments")}),!de){const a=document.getElementById("btn-begin-assessment");a&&a.addEventListener("click",async()=>{await Sr(t)});return}_r(e),document.querySelectorAll(".assessment-option").forEach(a=>{a.addEventListener("click",o=>{const i=o.currentTarget.dataset.questionId,r=Number.parseInt(o.currentTarget.dataset.optionIndex,10),d=re.get(i)||{questionId:i,type:"mcq",selectedIndex:null};re.set(i,{...d,selectedIndex:r}),document.querySelectorAll(`.assessment-option[data-question-id="${i}"]`).forEach(c=>{c.classList.toggle("option-btn--selected",Number.parseInt(c.dataset.optionIndex,10)===r)})})}),document.querySelectorAll(".assessment-response").forEach(a=>{a.addEventListener("input",o=>{const i=o.currentTarget.dataset.questionId,r=A.questions.find(d=>d.id===i);r&&(re.set(i,{questionId:i,type:r.type,responseText:o.currentTarget.value}),O==null||O.trackTextEntry(i,o.currentTarget.value))})});const n=document.getElementById("assessment-session-form");n&&n.addEventListener("submit",async a=>{a.preventDefault(),await Qt(e)})}function Se(e=""){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}async function Ar(e){const t=P(),s=await be(),n=await Ge(),a=s.find(i=>i.id===Number.parseInt(e,10)),o=n.find(i=>i.id===(a==null?void 0:a.assessmentId));return!a||!o?'<div class="container" style="padding: 2rem;">Assessment result not found.</div>':`
    ...
    <div class="container container--narrow view-enter assessment-results-page">
      ...
      ${tn(a.grading.totalScore,a.grading.maxScore)}
        ...
        <div class="assessment-remediation-list">
          ${a.grading.remediationPlan.length>0?a.grading.remediationPlan.map(i=>`
            <div class="assessment-remediation-item">
              ...
              <div class="assessment-remediation-item__objective">${Se(i.objective)}</div>
              <div class="assessment-remediation-item__action">${Se(i.action)}</div>
            </div>
      ...
      <div class="results-review">
        ...
        ${a.grading.questionScores.map((i,r)=>{var d;return`
          <div class="review-item ${i.normalizedScore>=.6?"review-item--correct":"review-item--incorrect"}">
            <div class="review-item__question">${r+1}. ${Se(i.prompt)}</div>
            <div class="review-item__meta">
              <span>${i.type}</span>
              ...
              <div class="assessment-rubric-breakdown">
                ${i.rubricBreakdown.map(c=>`
                  <div class="assessment-rubric-breakdown__item">
                    <strong>${Se(c.criterion)}:</strong> ${c.score}/${c.maxScore} - ${Se(c.evidence||"")}
                  </div>
                `).join("")}
              </div>
            `:""}
  ...
  `}function Cr(e,t){q({onBack:()=>e("/assessments")});const s=document.getElementById("btn-back-to-center"),n=document.getElementById("btn-retake-assessment");be().then(a=>{const o=a.find(i=>i.id===Number.parseInt(t,10));o&&(s&&s.addEventListener("click",()=>e("/assessments")),n&&n.addEventListener("click",()=>e(`/assessment/${o.assessmentId}`)))})}const vt={sbaPercent:30,diagnosticPercent:20,examPercent:50};function Lr(e){const t=Math.max(0,Math.min(100,Math.round(e||0)));return t>=90?{grade:1,label:"Grade 1",descriptor:"Excellent",letter:"A1",tone:"success",remark:"Outstanding performance and deep conceptual mastery."}:t>=80?{grade:2,label:"Grade 2",descriptor:"Very Good",letter:"B2",tone:"success",remark:"Very strong mastery; consistently demonstrates high ability."}:t>=70?{grade:3,label:"Grade 3",descriptor:"Good",letter:"B3",tone:"primary",remark:"Solid grasp of fundamental computing concepts."}:t>=60?{grade:4,label:"Grade 4",descriptor:"High Average",letter:"C4",tone:"primary",remark:"Satisfactory work; demonstrates steady progress in computing tasks."}:t>=55?{grade:5,label:"Grade 5",descriptor:"Average",letter:"C5",tone:"accent",remark:"Fair understanding; needs targeted practice on technical terms."}:t>=50?{grade:6,label:"Grade 6",descriptor:"Low Average",letter:"C6",tone:"warning",remark:"Average performance; additional review of key concepts required."}:t>=45?{grade:7,label:"Grade 7",descriptor:"Lower",letter:"D7",tone:"warning",remark:"Below expected standard; regular remediation recommended."}:t>=40?{grade:8,label:"Grade 8",descriptor:"Lowest",letter:"E8",tone:"danger",remark:"Weak performance; urgent intervention needed in basic computing."}:{grade:9,label:"Grade 9",descriptor:"Fail",letter:"F9",tone:"danger",remark:"Did not meet minimum competency requirements. Remedial support required."}}function Er(e){const t=["th","st","nd","rd"],s=e%100;return e+(t[(s-20)%10]||t[s]||t[0])}function Tr(e,{results:t=[],progress:s=[],diagnostics:n=[],submissions:a=[],weights:o=vt}){const i=t.filter(T=>T.studentId===e.id),r=s.filter(T=>T.studentId===e.id),d=n.filter(T=>T.studentId===e.id),c=a.filter(T=>T.studentId===e.id),u={};L.forEach(T=>{const j=i.filter(ue=>ue.lessonId===T.id).sort((ue,ye)=>new Date(ye.completedAt)-new Date(ue.completedAt))[0];u[T.id]=j&&j.totalQuestions>0?Math.round(j.score/j.totalQuestions*100):null});const l=Object.values(u).filter(T=>T!==null),p=l.length>0?l.reduce((T,j)=>T+j,0)/l.length:0,h=r.length/Math.max(1,L.length)*100,m=Math.round(p*.8+h*.2),g=d.sort((T,j)=>new Date(j.completedAt)-new Date(T.completedAt))[0];let v=50;if(g){const T=g.estimatedTheta??0;v=Math.max(0,Math.min(100,Math.round(50+T*16.67)))}const f=c.sort((T,j)=>new Date(j.completedAt)-new Date(T.completedAt))[0];let S=null;f&&f.maxScore>0?S=Math.round(f.totalScore/f.maxScore*100):l.length>0?S=Math.round(p):S=0;const b=(o.sbaPercent||30)/100,y=(o.diagnosticPercent||20)/100,I=(o.examPercent||50)/100,w=Math.round(m*b),_=Math.round(v*y),B=Math.round(S*I),N=Math.round(w+_+B),G=Lr(N);return{student:e,lessonScores:u,rawQuizAverage:Math.round(p),completionCount:r.length,sbaRaw:m,weightedSBA:w,diagnosticRaw:v,weightedDiag:_,examRaw:S,weightedExam:B,totalPercentage:N,bece:G,quizzesTaken:i.length,hasExamSubmission:!!f,latestDiagnostic:g}}function Br(e){return e.slice().sort((s,n)=>n.totalPercentage!==s.totalPercentage?n.totalPercentage-s.totalPercentage:n.sbaRaw-s.sbaRaw).map((s,n)=>({...s,rankNumber:n+1,rankOrdinal:Er(n+1),isTopThree:n<3}))}function Mn(e,{classes:t=[],students:s=[],results:n=[],progress:a=[],diagnostics:o=[],submissions:i=[],weights:r=vt}){const d=e==="all"?{id:"all",name:"All Classes",gradeLevel:"B7",academicYear:"2026/2027",term:"Term 1"}:t.find(v=>String(v.id)===String(e))||t[0]||{id:1,name:"General",gradeLevel:"B7"},u=(e==="all"?s:s.filter(v=>String(v.classId)===String(d.id))).map(v=>Tr(v,{results:n,progress:a,diagnostics:o,submissions:i,weights:r})),l=Br(u),p=l.length>0?Math.round(l.reduce((v,f)=>v+f.totalPercentage,0)/l.length):0,h=l.length>0?Math.max(...l.map(v=>v.totalPercentage)):0,m=l.length>0?Math.min(...l.map(v=>v.totalPercentage)):0,g={};for(let v=1;v<=9;v+=1)g[v]=l.filter(f=>f.bece.grade===v).length;return{classInfo:d,weights:r,lessons:L,students:l,statistics:{totalStudents:l.length,classAverage:p,highestScore:h,lowestScore:m,gradeDistribution:g}}}function Dr(e){const t=["Rank","Index Number","Student Name","Class",...L.map(n=>`L${n.id}: ${n.title}`),`SBA Raw (${e.weights.sbaPercent}%)`,`Diagnostic Raw (${e.weights.diagnosticPercent}%)`,`Exam Raw (${e.weights.examPercent}%)`,"Total Percentage","BECE Grade","Descriptor"],s=e.students.map(n=>[n.rankOrdinal,`"${n.student.indexNumber||""}"`,`"${n.student.name}"`,`"${e.classInfo.name}"`,...L.map(a=>n.lessonScores[a.id]!==null?`${n.lessonScores[a.id]}%`:"N/A"),`${n.sbaRaw}%`,`${n.diagnosticRaw}%`,`${n.examRaw}%`,`${n.totalPercentage}%`,`Grade ${n.bece.grade}`,`"${n.bece.descriptor}"`]);return[t.join(","),...s.map(n=>n.join(","))].join(`
`)}function Mr(e,{classes:t=[],students:s=[],results:n=[],progress:a=[],diagnostics:o=[],submissions:i=[],weights:r=vt}){const d=s.find(g=>g.id===Number.parseInt(e,10));if(!d)return null;const c=t.find(g=>g.id===d.classId)||t[0]||{id:1,name:"B7 — JHS 1A",gradeLevel:"B7",academicYear:"2026/2027",term:"Term 1",teacherName:"Class Teacher"},u=Mn(c.id,{classes:t,students:s,results:n,progress:a,diagnostics:o,submissions:i,weights:r}),l=u.students.find(g=>g.student.id===d.id);if(!l)return null;const h=n.filter(g=>g.studentId===d.id).sort((g,v)=>new Date(g.completedAt)-new Date(v.completedAt)).map(g=>{var v;return{completedAt:g.completedAt,lessonId:g.lessonId,lessonTitle:((v=L.find(f=>f.id===g.lessonId))==null?void 0:v.title)||`Lesson ${g.lessonId}`,theta:Number((g.theta||0).toFixed(2))}}),m=L.map(g=>{const v=l.lessonScores[g.id],f=a.some(b=>b.studentId===d.id&&b.lessonId===g.id);let S="Not yet attempted.";return v!==null&&(v>=80?S="Mastered core objectives.":v>=60?S="Demonstrates competent understanding.":S="Requires further reinforcement."),{id:g.id,title:g.title,strand:`Strand ${g.id}: Computer Systems`,score:v,isCompleted:f,remark:S}});return{student:d,studentClass:c,studentData:l,classTotalStudents:u.students.length,classAverage:u.statistics.classAverage,strands:m,thetaHistory:h,weights:r,attendance:{daysPresent:Math.min(60,52+d.id%8),totalDays:60},conduct:l.totalPercentage>=70?"Exemplary behavior, attentive during lab practicals, and shows positive initiative.":"Well behaved; advised to dedicate more time to hands-on computer practice.",headmasterRemark:l.totalPercentage>=70?"An impressive performance. Keep up the high standard.":"Has potential to do much better with consistent study and practice."}}let at="all",Rn={...vt},ze=null;function Ee(e=""){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}async function Ft(){const[e,t,s,n,a,o]=await Promise.all([se(),Y(),fe(),ut(),pt(),be()]);ze=Mn(at,{classes:e,students:t,results:s,progress:n,diagnostics:a,submissions:o,weights:Rn});const{classInfo:i,statistics:r,weights:d,lessons:c,students:u}=ze;return`
    ...
    <div class="container view-enter gradebook-page" style="padding-top: var(--space-6);">
      ...
      <div class="gradebook-header">
        <div>
          <h1 class="gradebook-header__title">${Ee(i.name)} — Continuous Assessment</h1>
          <p class="dashboard-header__subtitle">
            GES Standard 9-Point Grading & Weighted Terminal Broadsheet · Academic Year ${Ee(i.academicYear||"2026/2027")}
          </p>
        </div>
        <div class="gradebook-header__actions">
          <select id="gradebook-class-select" class="select-class">
            <option value="all" ${at==="all"?"selected":""}>All Classes (${t.length} students)</option>
            ${e.map(l=>`
              <option value="${l.id}" ${String(at)===String(l.id)?"selected":""}>
                ${Ee(l.name)} (${t.filter(p=>p.classId===l.id).length})
              </option>
            `).join("")}
          </select>
          ...
          <tbody>
            ${u.length>0?u.map(l=>{let p="rank-badge--other";return l.rankNumber===1?p="rank-badge--1":l.rankNumber===2?p="rank-badge--2":l.rankNumber===3&&(p="rank-badge--3"),`
                <tr>
                  ...
                  <td><code>${Ee(l.student.indexNumber||`GES-B7-${l.student.id}`)}</code></td>
                  <td style="font-weight: var(--font-weight-semibold);">${Ee(l.student.name)}</td>
  ...
  `}function Gt(e){q({onBack:()=>e("/dashboard")});const t=document.getElementById("gradebook-class-select");t&&t.addEventListener("change",async a=>{at=a.target.value;const o=await Ft(),i=document.getElementById("app");i&&(i.innerHTML=o,Gt(e))});const s=document.getElementById("btn-apply-weights");s&&s.addEventListener("click",async()=>{var c,u,l;const a=Number.parseInt((c=document.getElementById("weight-sba"))==null?void 0:c.value,10)||0,o=Number.parseInt((u=document.getElementById("weight-diag"))==null?void 0:u.value,10)||0,i=Number.parseInt((l=document.getElementById("weight-exam"))==null?void 0:l.value,10)||0;if(a+o+i!==100){C(`Weights must sum to 100% (currently ${a+o+i}%).`,"error");return}Rn={sbaPercent:a,diagnosticPercent:o,examPercent:i},C("Gradebook weighting updated.","success");const r=await Ft(),d=document.getElementById("app");d&&(d.innerHTML=r,Gt(e))});const n=document.getElementById("btn-export-broadsheet-csv");n&&n.addEventListener("click",()=>{if(!ze)return;const a=Dr(ze),o=`broadsheet_${ze.classInfo.name.toLowerCase().replace(/[^a-z0-9]/g,"_")}.csv`;Ys(a,o),C("Broadsheet exported successfully.","success")}),document.querySelectorAll(".btn-view-report-card").forEach(a=>{a.addEventListener("click",o=>{const i=o.currentTarget.dataset.studentId;e(`/report-card/${i}`)})})}let Ls=null;function U(e=""){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}async function Rr(e=null){var S;const[t,s,n,a,o,i]=await Promise.all([se(),Y(),fe(),ut(),pt(),be()]);Ls=e?Number.parseInt(e,10):(S=s[0])==null?void 0:S.id;const r=s.find(b=>b.id===Ls)||s[0];if(!r)return`
    ...
    `;const d=Mr(r.id,{classes:t,students:s,results:n,progress:a,diagnostics:o,submissions:i});if(!d)return`
      ${M({title:"Terminal Report Card",showBack:!0})}
      <div class="container view-enter" style="padding-top: var(--space-12); text-align: center;">
          ...
          <select id="report-student-select" class="select-class">
            ${s.map(b=>`
              <option value="${b.id}" ${b.id===c.id?"selected":""}>
                ${U(b.name)} (${U(b.indexNumber||`GES-B7-${b.id}`)})
              </option>
            `).join("")}
          </select>
        </div>
        ...
        <div class="report-sheet">
          ...
          <div class="report-header">
            ...
            <div style="font-size: 11px; color: #64748b; margin-top: 4px;">
              Academic Year: <strong>${U(u.academicYear||"2026/2027")}</strong> · Term: <strong>${U(u.term||"Term 1")}</strong>
            </div>
          </div>
          ...
          <div class="report-meta-grid">
            <div class="report-meta-item">
              ...
              <span class="report-meta-value">${U(c.name)}</span>
            </div>
            <div class="report-meta-item">
              <span class="report-meta-label">Student Index No.</span>
              <span class="report-meta-value">${U(c.indexNumber||`GES-B7-${c.id}`)}</span>
            </div>
            <div class="report-meta-item">
              <span class="report-meta-label">Class & Stream</span>
              <span class="report-meta-value">${U(u.name)}</span>
            </div>
            <div class="report-meta-item">
            ...
            <tbody>
              ${m.map(b=>{const y=b.score!==null?`${b.score}%`:"Pending",I=l.examRaw!==null?`${l.examRaw}%`:"Pending",w=b.score!==null?`${Math.round(b.score*.4+(l.examRaw||0)*.6)}%`:"—";return`
                  <tr>
                    ...
                    <td>
                      <strong>${U(b.title)}</strong>
                      <div style="font-size: 10px; color: #64748b;">${U(b.strand)}</div>
                    </td>
                    ...
                    <td style="font-size: 11px; color: #334155;">${U(b.remark)}</td>
                  </tr>
                `}).join("")}
            </tbody>
          </table>
          ...
          <div class="report-signatures-grid">
            <div>
              <div class="report-sig-line">
                <strong>${U(u.teacherName||"Class Teacher")}</strong><br>
  ...
  `}function Pr(e,t){q({onBack:()=>e("/gradebook")});const s=document.getElementById("report-student-select");s&&s.addEventListener("change",o=>{e(`/report-card/${o.target.value}`)});const n=document.getElementById("btn-back-gradebook");n&&n.addEventListener("click",()=>{e("/gradebook")});const a=document.getElementById("btn-print-report-card");a&&a.addEventListener("click",()=>{window.print()})}const We=new Map;let De=null;function Je(e=""){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Pn(){const e=ht(),t=[...We.values()].sort((s,n)=>String(s.studentName||s.clientId).localeCompare(String(n.studentName||n.clientId)));return`
    <div class="container view-enter lab-monitor-page">
      <section class="card card--glass lab-monitor-hero">
        ...
        ${e?`<div class="lab-join"><strong>Student link:</strong> <code>${Je(An(e))}</code><button class="btn btn--ghost btn--sm" id="lab-copy-link">Copy</button><span>Open this link on each PC (or turn it into a QR code using the browser’s Share menu).</span></div>`:""}
      </section>
      ...
      <section class="lab-monitor-grid">${t.length?t.map(s=>`<article class="card lab-student-card ${s.alert?"lab-student-card--alert":""}"><div class="lab-student-card__head"><strong>${Je(s.studentName||s.clientId||"Student PC")}</strong><span class="badge badge--${s.alert?"danger":s.status==="Completed"?"success":"primary"}">${Je(s.status||"Connected")}</span></div><p>${Je(s.detail||"Waiting for activity")}</p><small>Last seen ${new Date(s.sentAt||Date.now()).toLocaleTimeString()}</small>${s.alert?'<div class="lab-alert">Fullscreen exit or hidden tab detected</div>':""}</article>`).join(""):'<div class="card insight-empty">No student PCs have reported yet. Share the student link above and keep this page open.</div>'}</section>
    </div>`}function qn(){const e=document.getElementById("lab-monitor-root");e&&(e.innerHTML=Pn()),Nn()}function Nn(){var e,t,s,n,a;(e=document.getElementById("lab-new-room"))==null||e.addEventListener("click",()=>{br(),We.clear(),qn()}),(t=document.getElementById("lab-unlock"))==null||t.addEventListener("click",()=>$t()),(s=document.getElementById("lab-lock"))==null||s.addEventListener("click",()=>$t()),(n=document.getElementById("lab-submit"))==null||n.addEventListener("click",()=>$t()),(a=document.getElementById("lab-copy-link"))==null||a.addEventListener("click",async()=>{var o;await((o=navigator.clipboard)==null?void 0:o.writeText(An()))})}function qr(){return`${M({title:"Lab Monitor",showBack:!0,showLogout:!0})}<div id="lab-monitor-root">${Pn()}</div>`}function Nr(e){q({onBack:()=>e("/dashboard")}),De=Cn(t=>{if(t.type!=="status")return;const s=t.clientId||t.studentId||t.studentName||zr();We.set(s,t),qn()}),Nn()}function zr(){return`pc-${We.size+1}`}function jr(){De==null||De(),De=null,We.clear()}const At=(e="")=>String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;");function Or(e){const t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),s=URL.createObjectURL(t),n=document.createElement("a");n.href=s,n.download=`classconnect-${new Date().toISOString().slice(0,10)}.ccpack`,n.click(),URL.revokeObjectURL(s)}async function Qr(){const e=await Hs();return`${M({title:"Lesson CMS",showBack:!0,showLogout:!0})}
    <main class="container container--narrow view-enter cms-page">
      ...
      <section class="card cms-list"><h2>Saved custom lessons</h2>${e.length?e.map(t=>`<article><strong>${At(t.title)}</strong><span>${At(t.subject||"Computing")} · ${At(t.strand||"Unassigned")}</span></article>`).join(""):'<p class="insight-empty">No custom lessons yet.</p>'}</section>
    </main>`}function Fr(e){var t,s,n;q({onBack:()=>e("/dashboard")}),(t=document.getElementById("lesson-editor-form"))==null||t.addEventListener("submit",async a=>{a.preventDefault();const o=i=>document.getElementById(i).value.trim();await Us({title:o("cms-title"),strand:o("cms-strand"),subject:o("cms-subject"),objectives:o("cms-objectives").split(`
`).filter(Boolean),keyTerms:o("cms-terms").split(`
`).filter(Boolean),content:o("cms-body")}),C("Custom lesson saved locally.","success"),e("/lesson-editor")}),(s=document.getElementById("btn-export-pack"))==null||s.addEventListener("click",async()=>Or(await xa())),(n=document.getElementById("cms-import-pack"))==null||n.addEventListener("change",async a=>{try{const o=JSON.parse(await a.target.files[0].text()),i=await $a(o);C(`${i.lessons} lessons and ${i.questions} questions imported.`,"success"),e("/lesson-editor")}catch(o){C(o.message||"Could not import that lesson pack.","error")}})}const Ct=(e="")=>String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;");async function Gr(){const e=await Ks();return`${M({title:"Question Bank",showBack:!0,showLogout:!0})}<main class="container container--narrow view-enter cms-page"><div class="card"><h1 class="card__title">Author a question</h1><form id="question-editor-form" class="cms-form"><div class="cms-grid"><select class="input" id="question-type"><option value="mcq">Multiple choice</option><option value="true-false">True / False</option><option value="fill-blank">Fill in the blank</option><option value="short">Short answer</option><option value="code">Coding</option></select><select class="input" id="question-bloom"><option>Knowledge</option><option>Comprehension</option><option>Application</option><option>Analysis</option></select></div><textarea class="input" id="question-prompt" required rows="4" placeholder="Question prompt"></textarea><textarea class="input" id="question-options" rows="4" placeholder="Options, one per line (MCQ only)"></textarea><input class="input" id="question-answer" placeholder="Correct answer / answer key"><label>IRT difficulty (-3 to +3)<input class="input" id="question-difficulty" type="number" min="-3" max="3" step="0.1" value="0"></label><button class="btn btn--primary">Save question</button></form></div><section class="card cms-list"><h2>Saved questions</h2>${e.length?e.map(t=>`<article><strong>${Ct(t.type)} · ${Ct(t.bloom)}</strong><span>${Ct(t.prompt)}</span></article>`).join(""):'<p class="insight-empty">No custom questions yet.</p>'}</section></main>`}function Ur(e){var t;q({onBack:()=>e("/dashboard")}),(t=document.getElementById("question-editor-form"))==null||t.addEventListener("submit",async s=>{s.preventDefault();const n=a=>document.getElementById(a).value.trim();await Ws({type:n("question-type"),bloom:n("question-bloom"),prompt:n("question-prompt"),options:n("question-options").split(`
`).filter(Boolean),answer:n("question-answer"),difficulty:Number(n("question-difficulty"))}),C("Question saved to the local bank.","success"),e("/question-editor")})}let k=window.location.pathname;const Lt=document.getElementById("app"),Hr=4e3;async function Wr(){let e;try{await Promise.race([na(),new Promise((t,s)=>{e=window.setTimeout(()=>{s(new Error("Saved settings did not load in time."))},Hr)})])}finally{window.clearTimeout(e)}}async function R(e,t=!0){t&&e!==window.location.pathname&&window.history.pushState({},"",e),k=e,await he()}window.addEventListener("popstate",()=>{k=window.location.pathname,he()});function Kr(e){return e==="/lessons"||e==="/diagnostic"||e==="/assessments"||e.startsWith("/diagnostic-results/")||e.startsWith("/assessment/")||e.startsWith("/assessment-results/")||e.startsWith("/lesson/")||e.startsWith("/quiz/")||e.startsWith("/quiz-results/")||e==="/tutor"}async function he(){k==="/dashboard"&&!ps()&&(k="/teacher-login",window.history.replaceState({},"","/teacher-login")),(k==="/assessment-lab"||k==="/lab-monitor")&&!ps()&&(k="/teacher-login",window.history.replaceState({},"","/teacher-login")),Kr(k)&&!P()&&(k="/student-login",window.history.replaceState({},"","/student-login"));const e=document.getElementById("app-loader");e&&!e.classList.contains("hidden")&&(e.classList.add("hidden"),setTimeout(()=>e.remove(),1e3)),k.startsWith("/quiz/")||Ti(),k!=="/diagnostic"&&yn(),k.startsWith("/assessment/")||Ir(),k!=="/dashboard"&&Qe(),k!=="/lab-monitor"&&jr(),Lt.firstElementChild&&(Lt.firstElementChild.classList.add("view-exit"),await new Promise(n=>setTimeout(n,200)));let t="",s=()=>{};if(k==="/"||k==="/index.html")t=ja(),s=()=>Oa(R);else if(k==="/student-login")t=await Ha(),s=()=>Wa(R);else if(k==="/teacher-login")t=Ka(),s=()=>Ya(R);else if(k==="/lessons")t=await ci(),s=()=>di(R);else if(k==="/assessments")t=await Zo(),s=()=>Xo(R);else if(k==="/diagnostic")vo(),t=fo(),s=()=>bo(R,he);else if(k.startsWith("/diagnostic-results/")){const n=k.split("/")[2];t=await Co(n),s=()=>Lo(R,n)}else if(k.startsWith("/lesson/")){const n=Number.parseInt(k.split("/")[2],10);t=await li(n),s=()=>ui(R,n)}else if(k.startsWith("/quiz/")){const n=Number.parseInt(k.split("/")[2],10);Ei(n),t=Bi(),s=()=>Di(R,he,n)}else if(k.startsWith("/quiz-results/")){const n=k.split("/")[2];t=await Ri(n),s=()=>Pi(R,n)}else if(k.startsWith("/assessment-results/")){const n=k.split("/")[2];t=await Ar(n),s=()=>Cr(R,n)}else if(k.startsWith("/assessment/")){const n=Number.parseInt(k.split("/")[2],10);await wr(n),t=xr(),s=()=>$r(R,he)}else if(k==="/tutor")t=await Mo(),s=()=>Ro(R,he);else if(k==="/assessment-lab")t=await Vo(),s=()=>Jo(R);else if(k==="/lab-monitor")t=qr(),s=()=>Nr(R);else if(k==="/lesson-editor")t=await Qr(),s=()=>Fr(R);else if(k==="/question-editor")t=await Gr(),s=()=>Ur(R);else if(k==="/gradebook")t=await Ft(),s=()=>Gt(R);else if(k==="/report-card"||k.startsWith("/report-card/")){const n=k.split("/")[2]||null;t=await Rr(n),s=()=>Pr(R)}else if(k==="/dashboard")t=await so(),s=()=>no(R);else{R("/",!1);return}Lt.innerHTML=t,setTimeout(s,0),window.scrollTo(0,0)}window.addEventListener("DOMContentLoaded",()=>{const t=new URLSearchParams(window.location.search).has("capture")?0:1500;setTimeout(async()=>{try{await Wr()}catch(s){console.error("Unable to load saved ClassConnect settings.",s)}Ra(),Zs(),await he()},t)});
